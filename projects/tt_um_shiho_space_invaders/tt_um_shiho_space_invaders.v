module tt_um_shiho_space_invaders (clk,
    ena,
    rst_n,
    VPWR,
    VGND,
 ...
 wire \game.alien_y[8] ;
 wire \game.alien_y[9] ;
 wire \game.aliens_alive[0] ;
 wire \game.aliens_alive[1] ;
 wire \game.aliens_alive[2] ;
 wire \game.aliens_alive[3] ;
 wire \game.aliens_alive[4] ;
 wire \game.aliens_alive[5] ;
 wire \game.aliens_alive[6] ;
 wire \game.aliens_alive[7] ;
 wire \game.hsync ;
 wire \game.pixel_x[0] ;
 wire \game.pixel_x[10] ;
 wire \game.pixel_x[1] ;
 wire \game.pixel_x[2] ;
 wire \game.pixel_x[3] ;
 wire \game.pixel_x[4] ;
 ...
 wire \game.pixel_y[8] ;
 wire \game.pixel_y[9] ;
 wire \game.player_x[0] ;
 wire \game.player_x[10] ;
 wire \game.player_x[1] ;
 wire \game.player_x[2] ;
 wire \game.player_x[3] ;
 wire \game.player_x[4] ;
 wire \game.player_x[5] ;
 wire \game.player_x[6] ;
 wire \game.player_x[7] ;
 wire \game.player_x[8] ;
 wire \game.player_x[9] ;
 wire \game.proj_active ;
 wire \game.proj_x[0] ;
 wire \game.proj_x[10] ;
 wire \game.proj_x[1] ;
 wire \game.proj_x[2] ;
 ...
 wire \game.vsync_d ;
 wire \game.wait_cnt[0] ;
 wire \game.wait_cnt[1] ;
 wire \game.wait_cnt[2] ;
 ...
 sky130_fd_sc_hd__decap_3 FILLER_12_3 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__fill_1 FILLER_12_320 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_3 FILLER_23_109 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__fill_1 FILLER_23_118 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_137 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__a21bo_2 _0673_ (.A1(\gamepad.driver.shift_reg[9] ),
    .A2(net18),
    .B1_N(net58),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0655_));
 sky130_fd_sc_hd__a21o_2 _0674_ (.A1(net99),
    .A2(net17),
    .B1(_0655_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0091_));
 sky130_fd_sc_hd__a21bo_2 _0675_ (.A1(\gamepad.driver.shift_reg[10] ),
    .A2(net18),
    .B1_N(net59),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0656_));
 sky130_fd_sc_hd__a21o_2 _0676_ (.A1(net94),
    .A2(net17),
    .B1(_0656_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0092_));
 sky130_fd_sc_hd__and2_2 _0677_ (.A(net60),
    .B(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0093_));
 sky130_fd_sc_hd__and2_2 _0678_ (.A(net60),
    .B(net98),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0094_));
 sky130_fd_sc_hd__and2_2 _0679_ (.A(net60),
    .B(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0095_));
 sky130_fd_sc_hd__and2_2 _0680_ (.A(net59),
    .B(net96),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0096_));
 sky130_fd_sc_hd__and2_2 _0681_ (.A(net56),
    .B(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0097_));
 sky130_fd_sc_hd__and2_2 _0682_ (.A(net56),
    .B(net97),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0098_));
 sky130_fd_sc_hd__o211a_2 _0683_ (.A1(net32),
    .A2(_0447_),
    .B1(_0452_),
    .C1(_0444_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0657_));
 sky130_fd_sc_hd__xor2_2 _0684_ (.A(net21),
    .B(_0657_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0099_));
 sky130_fd_sc_hd__a21oi_2 _0685_ (.A1(net21),
    .A2(_0657_),
    .B1(\game.alien_y[6] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0658_));
 sky130_fd_sc_hd__and3_2 _0686_ (.A(net21),
    .B(\game.alien_y[6] ),
    .C(_0657_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0659_));
 sky130_fd_sc_hd__nor2_2 _0687_ (.A(_0658_),
    .B(_0659_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0100_));
 sky130_fd_sc_hd__or2_2 _0688_ (.A(\game.alien_y[7] ),
    .B(_0659_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0660_));
 sky130_fd_sc_hd__nand2_2 _0689_ (.A(\game.alien_y[7] ),
    .B(_0659_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0661_));
 sky130_fd_sc_hd__and2_2 _0690_ (.A(_0660_),
    .B(_0661_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0101_));
 sky130_fd_sc_hd__xnor2_2 _0691_ (.A(net149),
    .B(_0661_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0102_));
 sky130_fd_sc_hd__mux2_1 _0692_ (.A0(\game.alien_y[9] ),
    .A1(_0242_),
    .S(_0657_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0103_));
 sky130_fd_sc_hd__or3_2 _0693_ (.A(_0147_),
    .B(net11),
    .C(_0605_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0662_));
 sky130_fd_sc_hd__or4b_2 _0694_ (.A(_0141_),
    .B(\game.proj_y[3] ),
    .C(_0383_),
    .D_N(_0604_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0663_));
 sky130_fd_sc_hd__nand2_2 _0695_ (.A(_0662_),
    .B(_0663_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0104_));
 sky130_fd_sc_hd__nand2_2 _0696_ (.A(_0584_),
    .B(_0663_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0664_));
 sky130_fd_sc_hd__or2_2 _0697_ (.A(\game.proj_y[4] ),
    .B(_0663_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0665_));
 sky130_fd_sc_hd__o21ai_2 _0698_ (.A1(_0146_),
    .A2(_0664_),
    .B1(_0665_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0105_));
 sky130_fd_sc_hd__or2_2 _0699_ (.A(\game.proj_y[5] ),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0666_));
 sky130_fd_sc_hd__mux2_1 _0700_ (.A0(_0145_),
    .A1(_0666_),
    .S(_0665_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0106_));
 sky130_fd_sc_hd__o21ai_2 _0701_ (.A1(\game.proj_y[5] ),
    .A2(_0665_),
    .B1(_0584_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0667_));
 sky130_fd_sc_hd__or3_2 _0702_ (.A(\game.proj_y[6] ),
    .B(\game.proj_y[5] ),
    .C(_0665_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0668_));
 sky130_fd_sc_hd__o21ai_2 _0703_ (.A1(_0144_),
    .A2(_0667_),
    .B1(_0668_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0107_));
 sky130_fd_sc_hd__o21ai_2 _0704_ (.A1(\game.proj_y[7] ),
    .A2(net11),
    .B1(_0668_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0669_));
 sky130_fd_sc_hd__or2_2 _0705_ (.A(\game.proj_y[7] ),
    .B(_0668_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0670_));
 sky130_fd_sc_hd__nand2_2 _0706_ (.A(_0669_),
    .B(_0670_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0108_));
 sky130_fd_sc_hd__or2_2 _0707_ (.A(\game.proj_y[8] ),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0671_));
 sky130_fd_sc_hd__mux2_1 _0708_ (.A0(_0142_),
    .A1(_0671_),
    .S(_0670_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0109_));
 sky130_fd_sc_hd__o211ai_2 _0709_ (.A1(\game.proj_y[8] ),
    .A2(_0670_),
    .B1(_0584_),
    .C1(\game.proj_y[9] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0672_));
 sky130_fd_sc_hd__o31ai_2 _0710_ (.A1(\game.proj_y[8] ),
    .A2(\game.proj_y[9] ),
    .A3(_0670_),
    .B1(_0672_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0110_));
 sky130_fd_sc_hd__nor2_2 _0711_ (.A(_0150_),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0111_));
 sky130_fd_sc_hd__nor2_2 _0712_ (.A(_0148_),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0112_));
 sky130_fd_sc_hd__or2_2 _0713_ (.A(net141),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0113_));
 sky130_fd_sc_hd__inv_2 _0714_ (.A(\game.player_x[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0114_));
 sky130_fd_sc_hd__inv_2 _0715_ (.A(\game.proj_x[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0115_));
 sky130_fd_sc_hd__inv_2 _0716_ (.A(\game.proj_x[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0116_));
 sky130_fd_sc_hd__inv_2 _0717_ (.A(\game.proj_x[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0117_));
 sky130_fd_sc_hd__inv_2 _0718_ (.A(\game.alien_x[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0118_));
 sky130_fd_sc_hd__inv_2 _0719_ (.A(\game.proj_x[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0119_));
 sky130_fd_sc_hd__inv_2 _0720_ (.A(\game.alien_x[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0120_));
 sky130_fd_sc_hd__inv_2 _0721_ (.A(\game.alien_x[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0121_));
 sky130_fd_sc_hd__inv_2 _0722_ (.A(\game.alien_x[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0122_));
 sky130_fd_sc_hd__inv_2 _0723_ (.A(\game.proj_x[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0123_));
 sky130_fd_sc_hd__inv_2 _0724_ (.A(\game.proj_x[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0124_));
 sky130_fd_sc_hd__inv_2 _0725_ (.A(\game.proj_x[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0125_));
 sky130_fd_sc_hd__inv_2 _0726_ (.A(\game.aliens_alive[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0126_));
 sky130_fd_sc_hd__inv_2 _0727_ (.A(\game.aliens_alive[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0127_));
 sky130_fd_sc_hd__inv_2 _0728_ (.A(\game.aliens_alive[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0128_));
 sky130_fd_sc_hd__inv_2 _0729_ (.A(\game.aliens_alive[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0129_));
 sky130_fd_sc_hd__inv_2 _0730_ (.A(net28),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _0731_ (.A(net29),
    ...
    .VPWR(VPWR),
    .Y(_0131_));
 sky130_fd_sc_hd__inv_2 _0732_ (.A(net30),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0132_));
 sky130_fd_sc_hd__inv_2 _0733_ (.A(\game.pixel_y[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0133_));
 sky130_fd_sc_hd__inv_2 _0734_ (.A(\game.pixel_y[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0134_));
 sky130_fd_sc_hd__inv_2 _0735_ (.A(\game.player_x[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _0737_ (.A(net38),
    ...
    .VPWR(VPWR),
    .Y(_0137_));
 sky130_fd_sc_hd__inv_2 _0738_ (.A(\game.player_x[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0138_));
 sky130_fd_sc_hd__inv_2 _0739_ (.A(\game.player_x[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0139_));
 sky130_fd_sc_hd__inv_2 _0740_ (.A(\game.alien_x[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0140_));
 sky130_fd_sc_hd__inv_2 _0741_ (.A(\game.proj_active ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0141_));
 sky130_fd_sc_hd__inv_2 _0742_ (.A(\game.proj_y[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0142_));
 sky130_fd_sc_hd__inv_2 _0743_ (.A(\game.proj_y[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0143_));
 sky130_fd_sc_hd__inv_2 _0744_ (.A(\game.proj_y[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0144_));
 sky130_fd_sc_hd__inv_2 _0745_ (.A(\game.proj_y[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0145_));
 sky130_fd_sc_hd__inv_2 _0746_ (.A(\game.proj_y[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0146_));
 sky130_fd_sc_hd__inv_2 _0747_ (.A(\game.proj_y[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0147_));
 sky130_fd_sc_hd__inv_2 _0748_ (.A(net152),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0148_));
 sky130_fd_sc_hd__inv_2 _0749_ (.A(\game.proj_y[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0149_));
 sky130_fd_sc_hd__inv_2 _0750_ (.A(net140),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0150_));
 sky130_fd_sc_hd__inv_2 _0751_ (.A(\game.proj_x[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0151_));
 sky130_fd_sc_hd__inv_2 _0752_ (.A(\game.proj_x[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0152_));
 sky130_fd_sc_hd__inv_2 _0753_ (.A(net143),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0000_));
 sky130_fd_sc_hd__inv_2 _0754_ (.A(\game.pixel_x[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0153_));
 sky130_fd_sc_hd__inv_2 _0755_ (.A(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0154_));
 sky130_fd_sc_hd__inv_2 _0756_ (.A(net27),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0155_));
 sky130_fd_sc_hd__inv_2 _0757_ (.A(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0156_));
 sky130_fd_sc_hd__inv_2 _0758_ (.A(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0157_));
 sky130_fd_sc_hd__inv_2 _0759_ (.A(\game.pixel_x[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0158_));
 sky130_fd_sc_hd__inv_2 _0760_ (.A(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0159_));
 sky130_fd_sc_hd__inv_2 _0761_ (.A(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0160_));
 sky130_fd_sc_hd__nand2_2 _0762_ (.A(net28),
    .B(net29),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0161_));
 sky130_fd_sc_hd__and4_2 _0763_ (.A(net28),
    .B(net29),
    .C(net31),
    .D(net30),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0162_));
 sky130_fd_sc_hd__and3b_2 _0764_ (.A_N(\game.pixel_y[2] ),
    .B(_0134_),
    .C(\game.pixel_y[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0163_));
 sky130_fd_sc_hd__and4_2 _0765_ (.A(\game.pixel_y[3] ),
    .B(_0133_),
    .C(_0162_),
    .D(_0163_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0164_));
 sky130_fd_sc_hd__inv_2 _0766_ (.A(_0164_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\game.vga_inst.vsync ));
 sky130_fd_sc_hd__xor2_2 _0767_ (.A(net155),
    .B(\game.pixel_x[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0002_));
 sky130_fd_sc_hd__and3_2 _0768_ (.A(\game.pixel_x[0] ),
    .B(\game.pixel_x[1] ),
    .C(\game.pixel_x[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0165_));
 sky130_fd_sc_hd__a21oi_2 _0769_ (.A1(\game.pixel_x[0] ),
    .A2(\game.pixel_x[1] ),
    .B1(\game.pixel_x[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0166_));
 sky130_fd_sc_hd__nor2_2 _0770_ (.A(_0165_),
    .B(_0166_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0003_));
 sky130_fd_sc_hd__and2_2 _0771_ (.A(\game.pixel_x[3] ),
    .B(_0165_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0167_));
 sky130_fd_sc_hd__nor2_2 _0772_ (.A(\game.pixel_x[3] ),
    .B(_0165_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0168_));
 sky130_fd_sc_hd__nor2_2 _0773_ (.A(_0167_),
    .B(_0168_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0004_));
 sky130_fd_sc_hd__and3_2 _0774_ (.A(\game.pixel_x[3] ),
    .B(net27),
    .C(_0165_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0169_));
 sky130_fd_sc_hd__nor2_2 _0775_ (.A(net27),
    .B(_0167_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0170_));
 sky130_fd_sc_hd__nor2_2 _0776_ (.A(_0169_),
    .B(_0170_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0005_));
 sky130_fd_sc_hd__and3_2 _0777_ (.A(net26),
    .B(net27),
    .C(_0167_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0171_));
 sky130_fd_sc_hd__o211a_2 _0778_ (.A1(net24),
    .A2(net23),
    .B1(net22),
    .C1(_0158_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0172_));
 sky130_fd_sc_hd__or2_2 _0779_ (.A(net26),
    .B(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0173_));
 sky130_fd_sc_hd__nor2_2 _0780_ (.A(net24),
    .B(_0173_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0174_));
 sky130_fd_sc_hd__and3_2 _0781_ (.A(_0169_),
    .B(_0172_),
    .C(_0174_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0175_));
 sky130_fd_sc_hd__nor2_2 _0782_ (.A(_0171_),
    .B(_0175_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0176_));
 sky130_fd_sc_hd__o21a_2 _0783_ (.A1(net26),
    .A2(_0169_),
    .B1(_0176_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0006_));
 sky130_fd_sc_hd__nand2_2 _0784_ (.A(net25),
    .B(_0171_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0177_));
 sky130_fd_sc_hd__or2_2 _0785_ (.A(net25),
    .B(_0171_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0178_));
 sky130_fd_sc_hd__and2_2 _0786_ (.A(_0177_),
    .B(_0178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0007_));
 sky130_fd_sc_hd__xnor2_2 _0787_ (.A(net24),
    .B(_0177_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0008_));
 sky130_fd_sc_hd__and4_2 _0788_ (.A(net24),
    .B(net25),
    .C(net23),
    .D(_0171_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0179_));
 sky130_fd_sc_hd__a31o_2 _0789_ (.A1(\game.pixel_x[7] ),
    .A2(\game.pixel_x[6] ),
    .A3(_0171_),
    .B1(net23),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0180_));
 sky130_fd_sc_hd__nor3b_2 _0790_ (.A(_0175_),
    .B(_0179_),
    .C_N(_0180_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0009_));
 sky130_fd_sc_hd__or2_2 _0791_ (.A(net22),
    .B(_0179_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0181_));
 sky130_fd_sc_hd__nand2_2 _0792_ (.A(net22),
    .B(_0179_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0182_));
 sky130_fd_sc_hd__and3b_2 _0793_ (.A_N(_0175_),
    .B(_0181_),
    .C(_0182_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0010_));
 sky130_fd_sc_hd__xnor2_2 _0794_ (.A(\game.pixel_x[10] ),
    .B(_0182_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0001_));
 sky130_fd_sc_hd__or2_2 _0795_ (.A(\game.alien_x[8] ),
    .B(_0160_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0183_));
 sky130_fd_sc_hd__nand2_2 _0796_ (.A(\game.alien_x[8] ),
    .B(_0160_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0184_));
 sky130_fd_sc_hd__nand2_2 _0797_ (.A(_0183_),
    .B(_0184_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0185_));
 sky130_fd_sc_hd__nor2_2 _0798_ (.A(\game.alien_x[7] ),
    .B(_0156_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_2 _0799_ (.A(net34),
    ...
    .VPWR(VPWR),
    .Y(_0187_));
 sky130_fd_sc_hd__nand2_2 _0800_ (.A(net34),
    .B(_0157_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0188_));
 sky130_fd_sc_hd__nand2b_2 _0801_ (.A_N(_0187_),
    .B(_0188_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0189_));
 sky130_fd_sc_hd__nand2_2 _0802_ (.A(net35),
    .B(_0154_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0190_));
 sky130_fd_sc_hd__nor2_2 _0803_ (.A(net35),
    .B(_0154_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0191_));
 sky130_fd_sc_hd__or2_2 _0804_ (.A(net35),
    .B(_0154_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0192_));
 sky130_fd_sc_hd__nand2_2 _0805_ (.A(net36),
    .B(_0155_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0193_));
 sky130_fd_sc_hd__o22a_2 _0806_ (.A1(_0122_),
    .A2(\game.pixel_x[0] ),
    .B1(\game.pixel_x[1] ),
    .B2(_0121_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0194_));
 sky130_fd_sc_hd__a221o_2 _0807_ (.A1(_0121_),
    .A2(\game.pixel_x[1] ),
    .B1(\game.pixel_x[2] ),
    .B2(_0120_),
    .C1(_0194_),
    ...
    .VPWR(VPWR),
    .X(_0195_));
 sky130_fd_sc_hd__o22a_2 _0808_ (.A1(_0118_),
    .A2(\game.pixel_x[3] ),
    .B1(\game.pixel_x[2] ),
    .B2(_0120_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0196_));
 sky130_fd_sc_hd__o22a_2 _0809_ (.A1(\game.alien_x[3] ),
    .A2(_0153_),
    .B1(_0155_),
    .B2(net36),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0197_));
 sky130_fd_sc_hd__a21bo_2 _0810_ (.A1(_0195_),
    .A2(_0196_),
    .B1_N(_0197_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0198_));
 sky130_fd_sc_hd__a31o_2 _0811_ (.A1(_0190_),
    .A2(_0193_),
    .A3(_0198_),
    .B1(_0191_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0199_));
 sky130_fd_sc_hd__a21o_2 _0812_ (.A1(_0188_),
    .A2(_0199_),
    .B1(_0187_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0200_));
 sky130_fd_sc_hd__nand2_2 _0813_ (.A(\game.alien_x[7] ),
    .B(_0156_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0201_));
 sky130_fd_sc_hd__nand2b_2 _0814_ (.A_N(_0186_),
    .B(_0201_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0202_));
 sky130_fd_sc_hd__a21oi_2 _0815_ (.A1(_0200_),
    .A2(_0201_),
    .B1(_0186_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0203_));
 sky130_fd_sc_hd__xnor2_2 _0816_ (.A(_0185_),
    .B(_0203_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0204_));
 sky130_fd_sc_hd__xnor2_2 _0817_ (.A(_0200_),
    .B(_0202_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0205_));
 sky130_fd_sc_hd__xnor2_2 _0818_ (.A(_0189_),
    .B(_0199_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0206_));
 sky130_fd_sc_hd__mux4_2 _0819_ (.A0(_0126_),
    .A1(_0127_),
    .A2(_0128_),
    .A3(_0129_),
    .S0(_0206_),
    ...
    .VPWR(VPWR),
    .X(_0207_));
 sky130_fd_sc_hd__mux4_2 _0820_ (.A0(\game.aliens_alive[4] ),
    .A1(\game.aliens_alive[5] ),
    .A2(\game.aliens_alive[6] ),
    .A3(\game.aliens_alive[7] ),
    .S0(_0206_),
    .S1(_0205_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0208_));
 sky130_fd_sc_hd__nor2_2 _0821_ (.A(_0204_),
    .B(_0208_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0209_));
 sky130_fd_sc_hd__xor2_2 _0822_ (.A(\game.alien_x[10] ),
    .B(\game.pixel_x[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0210_));
 sky130_fd_sc_hd__a21o_2 _0823_ (.A1(_0140_),
    .A2(net22),
    .B1(_0210_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0211_));
 sky130_fd_sc_hd__nand2_2 _0824_ (.A(\game.alien_x[9] ),
    .B(_0159_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0212_));
 sky130_fd_sc_hd__o21ai_2 _0825_ (.A1(_0185_),
    .A2(_0203_),
    .B1(_0183_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0213_));
 sky130_fd_sc_hd__a21oi_2 _0826_ (.A1(_0212_),
    .A2(_0213_),
    .B1(_0211_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0214_));
 sky130_fd_sc_hd__or2_2 _0827_ (.A(_0134_),
    .B(\game.alien_y[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0215_));
 sky130_fd_sc_hd__nand2_2 _0828_ (.A(\game.pixel_y[3] ),
    .B(\game.pixel_y[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0216_));
 sky130_fd_sc_hd__and4_2 _0829_ (.A(\game.pixel_y[3] ),
    .B(\game.pixel_y[4] ),
    .C(\game.pixel_y[1] ),
    .D(\game.pixel_y[2] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0217_));
 sky130_fd_sc_hd__xor2_2 _0830_ (.A(net31),
    .B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0218_));
 sky130_fd_sc_hd__xnor2_2 _0831_ (.A(net21),
    .B(\game.alien_y[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0219_));
 sky130_fd_sc_hd__xnor2_2 _0832_ (.A(_0132_),
    .B(_0219_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0220_));
 sky130_fd_sc_hd__mux2_1 _0833_ (.A0(_0217_),
    .A1(_0220_),
    .S(_0218_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0221_));
 sky130_fd_sc_hd__o21ba_2 _0834_ (.A1(_0132_),
    .A2(\game.alien_y[6] ),
    .B1_N(_0221_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0222_));
 sky130_fd_sc_hd__a221o_2 _0835_ (.A1(_0132_),
    .A2(\game.alien_y[6] ),
    .B1(\game.alien_y[7] ),
    .B2(_0131_),
    .C1(_0222_),
    ...
    .VPWR(VPWR),
    .X(_0223_));
 sky130_fd_sc_hd__o221a_2 _0836_ (.A1(_0131_),
    .A2(\game.alien_y[7] ),
    .B1(\game.alien_y[8] ),
    .B2(_0130_),
    .C1(_0223_),
    ...
    .VPWR(VPWR),
    .X(_0224_));
 sky130_fd_sc_hd__nand2_2 _0837_ (.A(_0134_),
    .B(\game.alien_y[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0225_));
 sky130_fd_sc_hd__a221o_2 _0838_ (.A1(_0130_),
    .A2(\game.alien_y[8] ),
    .B1(\game.alien_y[9] ),
    .B2(_0134_),
    .C1(_0224_),
    ...
    .VPWR(VPWR),
    .X(_0226_));
 sky130_fd_sc_hd__nand2_2 _0839_ (.A(_0190_),
    .B(_0192_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0227_));
 sky130_fd_sc_hd__a21oi_2 _0840_ (.A1(_0193_),
    .A2(_0198_),
    .B1(_0227_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0228_));
 sky130_fd_sc_hd__and3_2 _0841_ (.A(_0193_),
    .B(_0198_),
    .C(_0227_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0229_));
 sky130_fd_sc_hd__a21o_2 _0842_ (.A1(net31),
    .A2(net21),
    .B1(_0217_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0230_));
 sky130_fd_sc_hd__o211a_2 _0843_ (.A1(net31),
    .A2(\game.alien_y[5] ),
    .B1(_0220_),
    .C1(_0230_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0231_));
 sky130_fd_sc_hd__and3_2 _0844_ (.A(net21),
    .B(\game.alien_y[6] ),
    .C(\game.alien_y[7] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0232_));
 sky130_fd_sc_hd__a21oi_2 _0845_ (.A1(net21),
    .A2(\game.alien_y[6] ),
    .B1(\game.alien_y[7] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0233_));
 sky130_fd_sc_hd__or2_2 _0846_ (.A(_0232_),
    .B(_0233_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0234_));
 sky130_fd_sc_hd__a221o_2 _0847_ (.A1(net30),
    .A2(_0219_),
    .B1(_0234_),
    .B2(net29),
    .C1(_0231_),
    ...
    .VPWR(VPWR),
    .X(_0235_));
 sky130_fd_sc_hd__and4_2 _0848_ (.A(\game.alien_y[5] ),
    .B(\game.alien_y[6] ),
    .C(\game.alien_y[7] ),
    .D(\game.alien_y[8] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0236_));
 sky130_fd_sc_hd__inv_2 _0849_ (.A(_0236_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0237_));
 sky130_fd_sc_hd__or2_2 _0850_ (.A(\game.alien_y[8] ),
    .B(_0232_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0238_));
 sky130_fd_sc_hd__nand2_2 _0851_ (.A(_0237_),
    .B(_0238_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0239_));
 sky130_fd_sc_hd__o221a_2 _0852_ (.A1(net29),
    .A2(_0234_),
    .B1(_0239_),
    .B2(net28),
    .C1(_0235_),
    ...
    .VPWR(VPWR),
    .X(_0240_));
 sky130_fd_sc_hd__xnor2_2 _0853_ (.A(\game.alien_y[9] ),
    .B(_0236_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0241_));
 sky130_fd_sc_hd__inv_2 _0854_ (.A(_0241_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0242_));
 sky130_fd_sc_hd__a221o_2 _0855_ (.A1(net28),
    .A2(_0239_),
    .B1(_0241_),
    .B2(\game.pixel_y[9] ),
    .C1(_0240_),
    ...
    .VPWR(VPWR),
    .X(_0243_));
 sky130_fd_sc_hd__nand2_2 _0856_ (.A(_0215_),
    .B(_0236_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0244_));
 sky130_fd_sc_hd__mux2_1 _0857_ (.A0(_0236_),
    .A1(_0244_),
    .S(_0225_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0245_));
 sky130_fd_sc_hd__or4_2 _0858_ (.A(\game.pixel_y[9] ),
    .B(\game.pixel_x[10] ),
    .C(_0162_),
    .D(_0172_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0246_));
 sky130_fd_sc_hd__a221o_2 _0859_ (.A1(_0210_),
    .A2(_0212_),
    .B1(_0243_),
    .B2(_0245_),
    .C1(_0246_),
    ...
    .VPWR(VPWR),
    .X(_0247_));
 sky130_fd_sc_hd__or3_2 _0860_ (.A(_0228_),
    .B(_0229_),
    .C(_0247_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0248_));
 sky130_fd_sc_hd__a221o_2 _0861_ (.A1(_0211_),
    .A2(_0213_),
    .B1(_0215_),
    .B2(_0226_),
    .C1(_0248_),
    ...
    .VPWR(VPWR),
    .X(_0249_));
 sky130_fd_sc_hd__a2111oi_4 _0862_ (.A1(_0204_),
    .A2(_0207_),
    .B1(_0209_),
    .C1(_0214_),
    .D1(_0249_),
    ...
    .VPWR(VPWR),
    .Y(net6));
 sky130_fd_sc_hd__a21o_2 _0863_ (.A1(\game.player_x[3] ),
    .A2(net41),
    .B1(net40),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0250_));
 sky130_fd_sc_hd__nand2_2 _0864_ (.A(net40),
    .B(net41),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0251_));
 sky130_fd_sc_hd__o21a_2 _0865_ (.A1(_0139_),
    .A2(_0251_),
    .B1(_0250_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0252_));
 sky130_fd_sc_hd__xnor2_2 _0866_ (.A(\game.player_x[3] ),
    .B(net41),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0253_));
 sky130_fd_sc_hd__nor2_2 _0867_ (.A(net27),
    .B(_0253_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0254_));
 sky130_fd_sc_hd__nand2b_2 _0868_ (.A_N(\game.player_x[2] ),
    .B(\game.pixel_x[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0255_));
 sky130_fd_sc_hd__nand2b_2 _0869_ (.A_N(\game.player_x[1] ),
    .B(\game.pixel_x[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0256_));
 sky130_fd_sc_hd__and2b_2 _0870_ (.A_N(\game.pixel_x[2] ),
    .B(\game.player_x[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0257_));
 sky130_fd_sc_hd__and2b_2 _0871_ (.A_N(\game.pixel_x[1] ),
    .B(\game.player_x[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0258_));
 sky130_fd_sc_hd__a311o_2 _0872_ (.A1(\game.player_x[0] ),
    .A2(_0000_),
    .A3(_0256_),
    .B1(_0257_),
    .C1(_0258_),
    ...
    .VPWR(VPWR),
    .X(_0259_));
 sky130_fd_sc_hd__and3_2 _0873_ (.A(_0153_),
    .B(_0255_),
    .C(_0259_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0260_));
 sky130_fd_sc_hd__a21o_2 _0874_ (.A1(_0255_),
    .A2(_0259_),
    .B1(_0153_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0261_));
 sky130_fd_sc_hd__nand2_2 _0875_ (.A(net27),
    .B(_0253_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0262_));
 sky130_fd_sc_hd__o211a_2 _0876_ (.A1(_0139_),
    .A2(_0260_),
    .B1(_0261_),
    .C1(_0262_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0263_));
 sky130_fd_sc_hd__a2bb2o_2 _0877_ (.A1_N(_0254_),
    .A2_N(_0263_),
    .B1(net26),
    .B2(_0252_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0264_));
 sky130_fd_sc_hd__xnor2_2 _0878_ (.A(net39),
    .B(_0250_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0265_));
 sky130_fd_sc_hd__o221a_2 _0879_ (.A1(\game.pixel_x[5] ),
    .A2(_0252_),
    .B1(_0265_),
    .B2(\game.pixel_x[6] ),
    .C1(_0264_),
    ...
    .VPWR(VPWR),
    .X(_0266_));
 sky130_fd_sc_hd__and3_2 _0880_ (.A(\game.player_x[7] ),
    .B(net39),
    .C(_0250_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0267_));
 sky130_fd_sc_hd__a21oi_2 _0881_ (.A1(net39),
    .A2(_0250_),
    .B1(\game.player_x[7] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0268_));
 sky130_fd_sc_hd__or2_2 _0882_ (.A(_0267_),
    .B(_0268_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0269_));
 sky130_fd_sc_hd__a221o_2 _0883_ (.A1(\game.pixel_x[6] ),
    .A2(_0265_),
    .B1(_0269_),
    .B2(\game.pixel_x[7] ),
    .C1(_0266_),
    ...
    .VPWR(VPWR),
    .X(_0270_));
 sky130_fd_sc_hd__and2_2 _0884_ (.A(net38),
    .B(_0267_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0271_));
 sky130_fd_sc_hd__nor2_2 _0885_ (.A(net38),
    .B(_0267_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0272_));
 sky130_fd_sc_hd__or2_2 _0886_ (.A(_0271_),
    .B(_0272_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0273_));
 sky130_fd_sc_hd__o221a_2 _0887_ (.A1(\game.pixel_x[7] ),
    .A2(_0269_),
    .B1(_0273_),
    .B2(net23),
    .C1(_0270_),
    ...
    .VPWR(VPWR),
    .X(_0274_));
 sky130_fd_sc_hd__nand2_2 _0888_ (.A(net37),
    .B(_0271_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0275_));
 sky130_fd_sc_hd__or2_2 _0889_ (.A(net37),
    .B(_0271_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0276_));
 sky130_fd_sc_hd__nand2_2 _0890_ (.A(_0275_),
    .B(_0276_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0277_));
 sky130_fd_sc_hd__a221o_2 _0891_ (.A1(net23),
    .A2(_0273_),
    .B1(_0277_),
    .B2(net22),
    .C1(_0274_),
    ...
    .VPWR(VPWR),
    .X(_0278_));
 sky130_fd_sc_hd__nor2_2 _0892_ (.A(\game.player_x[10] ),
    .B(_0158_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0279_));
 sky130_fd_sc_hd__and2_2 _0893_ (.A(\game.player_x[10] ),
    .B(_0158_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0280_));
 sky130_fd_sc_hd__a21oi_2 _0894_ (.A1(_0275_),
    .A2(_0279_),
    .B1(_0280_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0281_));
 sky130_fd_sc_hd__o221a_2 _0895_ (.A1(\game.pixel_x[9] ),
    .A2(_0277_),
    .B1(_0279_),
    .B2(_0275_),
    .C1(_0281_),
    ...
    .VPWR(VPWR),
    .X(_0282_));
 sky130_fd_sc_hd__a221o_2 _0896_ (.A1(net41),
    .A2(_0155_),
    .B1(_0261_),
    .B2(\game.player_x[3] ),
    .C1(_0260_),
    ...
    .VPWR(VPWR),
    .X(_0283_));
 sky130_fd_sc_hd__o221a_2 _0897_ (.A1(net40),
    .A2(_0154_),
    .B1(_0155_),
    .B2(net41),
    .C1(_0283_),
    ...
    .VPWR(VPWR),
    .X(_0284_));
 sky130_fd_sc_hd__a221o_2 _0898_ (.A1(net40),
    .A2(_0154_),
    .B1(_0157_),
    .B2(net39),
    .C1(_0284_),
    ...
    .VPWR(VPWR),
    .X(_0285_));
 sky130_fd_sc_hd__o221a_2 _0899_ (.A1(\game.player_x[7] ),
    .A2(_0156_),
    .B1(_0157_),
    .B2(net39),
    .C1(_0285_),
    ...
    .VPWR(VPWR),
    .X(_0286_));
 sky130_fd_sc_hd__a22o_2 _0900_ (.A1(_0136_),
    .A2(\game.pixel_x[9] ),
    .B1(net23),
    .B2(_0137_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0287_));
 sky130_fd_sc_hd__nand2_2 _0901_ (.A(net37),
    .B(_0159_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0288_));
 sky130_fd_sc_hd__o221a_2 _0902_ (.A1(_0138_),
    .A2(\game.pixel_x[7] ),
    .B1(\game.pixel_x[8] ),
    .B2(_0137_),
    .C1(_0288_),
    ...
    .VPWR(VPWR),
    .X(_0289_));
 sky130_fd_sc_hd__or3b_2 _0903_ (.A(_0286_),
    .B(_0287_),
    .C_N(_0289_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0290_));
 sky130_fd_sc_hd__a21oi_2 _0904_ (.A1(_0287_),
    .A2(_0288_),
    .B1(_0279_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0291_));
 sky130_fd_sc_hd__nor2_2 _0905_ (.A(net31),
    .B(\game.pixel_y[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0292_));
 sky130_fd_sc_hd__and3_2 _0906_ (.A(net30),
    .B(_0216_),
    .C(_0292_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0293_));
 sky130_fd_sc_hd__a41o_2 _0907_ (.A1(net31),
    .A2(_0132_),
    .A3(\game.pixel_y[3] ),
    .A4(\game.pixel_y[4] ),
    .B1(_0293_),
    ...
    .VPWR(VPWR),
    .X(_0294_));
 sky130_fd_sc_hd__or4b_2 _0908_ (.A(\game.player_x[10] ),
    .B(_0161_),
    .C(_0246_),
    .D_N(_0294_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0295_));
 sky130_fd_sc_hd__a221oi_4 _0909_ (.A1(_0278_),
    .A2(_0282_),
    .B1(_0290_),
    .B2(_0291_),
    .C1(_0295_),
    ...
    .VPWR(VPWR),
    .Y(net5));
 sky130_fd_sc_hd__nand2_2 _0910_ (.A(\game.proj_y[4] ),
    .B(\game.proj_y[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0296_));
 sky130_fd_sc_hd__and4_2 _0911_ (.A(\game.proj_y[6] ),
    .B(\game.proj_y[5] ),
    .C(\game.proj_y[4] ),
    .D(\game.proj_y[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0297_));
 sky130_fd_sc_hd__and3_2 _0912_ (.A(\game.proj_y[8] ),
    .B(\game.proj_y[7] ),
    .C(_0297_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0298_));
 sky130_fd_sc_hd__a21oi_2 _0913_ (.A1(\game.proj_y[7] ),
    .A2(_0297_),
    .B1(\game.proj_y[8] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0299_));
 sky130_fd_sc_hd__or2_2 _0914_ (.A(_0298_),
    .B(_0299_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0300_));
 sky130_fd_sc_hd__xnor2_2 _0915_ (.A(_0145_),
    .B(_0296_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0301_));
 sky130_fd_sc_hd__or2_2 _0916_ (.A(\game.proj_y[4] ),
    .B(\game.proj_y[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0302_));
 sky130_fd_sc_hd__nand2_2 _0917_ (.A(_0296_),
    .B(_0302_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0303_));
 sky130_fd_sc_hd__or2_2 _0918_ (.A(\game.pixel_y[4] ),
    .B(_0303_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0304_));
 sky130_fd_sc_hd__o22a_2 _0919_ (.A1(\game.pixel_y[1] ),
    .A2(_0148_),
    .B1(_0150_),
    .B2(\game.pixel_y[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0305_));
 sky130_fd_sc_hd__a22o_2 _0920_ (.A1(\game.pixel_y[1] ),
    .A2(_0148_),
    .B1(_0149_),
    .B2(\game.pixel_y[2] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0306_));
 sky130_fd_sc_hd__o22a_2 _0921_ (.A1(\game.pixel_y[2] ),
    .A2(_0149_),
    .B1(_0305_),
    .B2(_0306_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0307_));
 sky130_fd_sc_hd__o21a_2 _0922_ (.A1(\game.pixel_y[3] ),
    .A2(_0307_),
    .B1(\game.proj_y[3] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0308_));
 sky130_fd_sc_hd__a221o_2 _0923_ (.A1(\game.pixel_y[4] ),
    .A2(_0303_),
    .B1(_0307_),
    .B2(\game.pixel_y[3] ),
    .C1(_0308_),
    ...
    .VPWR(VPWR),
    .X(_0309_));
 sky130_fd_sc_hd__a22o_2 _0924_ (.A1(net31),
    .A2(_0301_),
    .B1(_0304_),
    .B2(_0309_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0310_));
 sky130_fd_sc_hd__a31o_2 _0925_ (.A1(\game.proj_y[5] ),
    .A2(\game.proj_y[4] ),
    .A3(\game.proj_y[3] ),
    .B1(\game.proj_y[6] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0311_));
 sky130_fd_sc_hd__nand2b_2 _0926_ (.A_N(_0297_),
    .B(_0311_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0312_));
 sky130_fd_sc_hd__o221a_2 _0927_ (.A1(net31),
    .A2(_0301_),
    .B1(_0312_),
    .B2(net30),
    .C1(_0310_),
    ...
    .VPWR(VPWR),
    .X(_0313_));
 sky130_fd_sc_hd__xnor2_2 _0928_ (.A(\game.proj_y[7] ),
    .B(_0297_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0314_));
 sky130_fd_sc_hd__a221o_2 _0929_ (.A1(net30),
    .A2(_0312_),
    .B1(_0314_),
    .B2(net29),
    .C1(_0313_),
    ...
    .VPWR(VPWR),
    .X(_0315_));
 sky130_fd_sc_hd__nor2_2 _0930_ (.A(_0134_),
    .B(\game.proj_y[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0316_));
 sky130_fd_sc_hd__and2_2 _0931_ (.A(_0134_),
    .B(\game.proj_y[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0317_));
 sky130_fd_sc_hd__o21ba_2 _0932_ (.A1(_0298_),
    .A2(_0317_),
    .B1_N(_0316_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0318_));
 sky130_fd_sc_hd__o22a_2 _0933_ (.A1(net28),
    .A2(_0300_),
    .B1(_0314_),
    .B2(net29),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0319_));
 sky130_fd_sc_hd__a22oi_2 _0934_ (.A1(net28),
    .A2(_0300_),
    .B1(_0315_),
    .B2(_0319_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0320_));
 sky130_fd_sc_hd__a21oi_2 _0935_ (.A1(\game.proj_x[10] ),
    .A2(_0158_),
    .B1(_0246_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0321_));
 sky130_fd_sc_hd__and3_2 _0936_ (.A(\game.proj_x[4] ),
    .B(\game.proj_x[3] ),
    .C(\game.proj_x[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0322_));
 sky130_fd_sc_hd__and2_2 _0937_ (.A(\game.proj_x[5] ),
    .B(_0322_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0323_));
 sky130_fd_sc_hd__and3_2 _0938_ (.A(\game.proj_x[6] ),
    .B(\game.proj_x[7] ),
    .C(_0323_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0324_));
 sky130_fd_sc_hd__a21oi_2 _0939_ (.A1(\game.proj_x[6] ),
    .A2(_0323_),
    .B1(\game.proj_x[7] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0325_));
 sky130_fd_sc_hd__or2_2 _0940_ (.A(_0324_),
    .B(_0325_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0326_));
 sky130_fd_sc_hd__xnor2_2 _0941_ (.A(\game.proj_x[6] ),
    .B(_0323_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0327_));
 sky130_fd_sc_hd__or2_2 _0942_ (.A(net25),
    .B(_0327_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0328_));
 sky130_fd_sc_hd__xnor2_2 _0943_ (.A(\game.proj_x[3] ),
    .B(\game.proj_x[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0329_));
 sky130_fd_sc_hd__or2_2 _0944_ (.A(\game.pixel_x[3] ),
    .B(_0329_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0330_));
 sky130_fd_sc_hd__or2_2 _0945_ (.A(\game.proj_x[2] ),
    .B(\game.pixel_x[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0331_));
 sky130_fd_sc_hd__nand2b_2 _0946_ (.A_N(\game.pixel_x[1] ),
    .B(\game.proj_x[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0332_));
 sky130_fd_sc_hd__and2b_2 _0947_ (.A_N(\game.proj_x[1] ),
    .B(\game.pixel_x[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0333_));
 sky130_fd_sc_hd__or3_2 _0948_ (.A(_0123_),
    .B(\game.pixel_x[0] ),
    .C(_0333_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0334_));
 sky130_fd_sc_hd__a22o_2 _0949_ (.A1(\game.proj_x[2] ),
    .A2(\game.pixel_x[2] ),
    .B1(_0332_),
    .B2(_0334_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0335_));
 sky130_fd_sc_hd__a21oi_2 _0950_ (.A1(\game.proj_x[3] ),
    .A2(\game.proj_x[2] ),
    .B1(\game.proj_x[4] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0336_));
 sky130_fd_sc_hd__or2_2 _0951_ (.A(_0322_),
    .B(_0336_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0337_));
 sky130_fd_sc_hd__a22o_2 _0952_ (.A1(\game.pixel_x[3] ),
    .A2(_0329_),
    .B1(_0337_),
    .B2(net27),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0338_));
 sky130_fd_sc_hd__a31o_2 _0953_ (.A1(_0330_),
    .A2(_0331_),
    .A3(_0335_),
    .B1(_0338_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0339_));
 sky130_fd_sc_hd__nor2_2 _0954_ (.A(\game.proj_x[5] ),
    .B(_0322_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0340_));
 sky130_fd_sc_hd__or2_2 _0955_ (.A(_0323_),
    .B(_0340_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0341_));
 sky130_fd_sc_hd__o221a_2 _0956_ (.A1(net27),
    .A2(_0337_),
    .B1(_0341_),
    .B2(net26),
    .C1(_0339_),
    ...
    .VPWR(VPWR),
    .X(_0342_));
 sky130_fd_sc_hd__a221o_2 _0957_ (.A1(net25),
    .A2(_0327_),
    .B1(_0341_),
    .B2(net26),
    .C1(_0342_),
    ...
    .VPWR(VPWR),
    .X(_0343_));
 sky130_fd_sc_hd__a22o_2 _0958_ (.A1(net24),
    .A2(_0326_),
    .B1(_0328_),
    .B2(_0343_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0344_));
 sky130_fd_sc_hd__and2_2 _0959_ (.A(\game.proj_x[8] ),
    .B(_0324_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0345_));
 sky130_fd_sc_hd__nor2_2 _0960_ (.A(\game.proj_x[8] ),
    .B(_0324_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0346_));
 sky130_fd_sc_hd__or2_2 _0961_ (.A(_0345_),
    .B(_0346_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0347_));
 sky130_fd_sc_hd__o22a_2 _0962_ (.A1(net24),
    .A2(_0326_),
    .B1(_0347_),
    .B2(net23),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0348_));
 sky130_fd_sc_hd__xnor2_2 _0963_ (.A(\game.proj_x[9] ),
    .B(_0345_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0349_));
 sky130_fd_sc_hd__a22o_2 _0964_ (.A1(net23),
    .A2(_0347_),
    .B1(_0349_),
    .B2(net22),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0350_));
 sky130_fd_sc_hd__a21oi_2 _0965_ (.A1(_0344_),
    .A2(_0348_),
    .B1(_0350_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0351_));
 sky130_fd_sc_hd__o21a_2 _0966_ (.A1(\game.proj_x[10] ),
    .A2(_0158_),
    .B1(_0345_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0352_));
 sky130_fd_sc_hd__a2bb2o_2 _0967_ (.A1_N(net22),
    .A2_N(_0349_),
    .B1(_0352_),
    .B2(\game.proj_x[9] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0353_));
 sky130_fd_sc_hd__xnor2_2 _0968_ (.A(\game.proj_x[2] ),
    .B(\game.pixel_x[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0354_));
 sky130_fd_sc_hd__a21oi_2 _0969_ (.A1(\game.pixel_x[3] ),
    .A2(_0329_),
    .B1(_0354_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0355_));
 sky130_fd_sc_hd__o311a_2 _0970_ (.A1(_0123_),
    .A2(\game.pixel_x[0] ),
    .A3(_0333_),
    .B1(_0354_),
    .C1(_0332_),
    ...
    .VPWR(VPWR),
    .X(_0356_));
 sky130_fd_sc_hd__a221o_2 _0971_ (.A1(_0119_),
    .A2(\game.pixel_x[3] ),
    .B1(_0330_),
    .B2(_0355_),
    .C1(_0356_),
    ...
    .VPWR(VPWR),
    .X(_0357_));
 sky130_fd_sc_hd__o221a_2 _0972_ (.A1(_0119_),
    .A2(\game.pixel_x[3] ),
    .B1(net27),
    .B2(_0117_),
    .C1(_0357_),
    ...
    .VPWR(VPWR),
    .X(_0358_));
 sky130_fd_sc_hd__a221o_2 _0973_ (.A1(_0116_),
    .A2(net26),
    .B1(net27),
    .B2(_0117_),
    .C1(_0358_),
    ...
    .VPWR(VPWR),
    .X(_0359_));
 sky130_fd_sc_hd__o221a_2 _0974_ (.A1(_0116_),
    .A2(net26),
    .B1(net25),
    .B2(_0115_),
    .C1(_0359_),
    ...
    .VPWR(VPWR),
    .X(_0360_));
 sky130_fd_sc_hd__a22o_2 _0975_ (.A1(_0125_),
    .A2(net24),
    .B1(net25),
    .B2(_0115_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0361_));
 sky130_fd_sc_hd__o22a_2 _0976_ (.A1(\game.proj_x[9] ),
    .A2(_0159_),
    .B1(_0160_),
    .B2(\game.proj_x[8] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0362_));
 sky130_fd_sc_hd__o22a_2 _0977_ (.A1(_0125_),
    .A2(net24),
    .B1(net22),
    .B2(_0152_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0363_));
 sky130_fd_sc_hd__o221a_2 _0978_ (.A1(_0124_),
    .A2(net23),
    .B1(_0360_),
    .B2(_0361_),
    .C1(_0363_),
    ...
    .VPWR(VPWR),
    .X(_0364_));
 sky130_fd_sc_hd__a21oi_2 _0979_ (.A1(\game.proj_x[9] ),
    .A2(_0159_),
    .B1(_0362_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0365_));
 sky130_fd_sc_hd__a221o_2 _0980_ (.A1(_0151_),
    .A2(\game.pixel_x[10] ),
    .B1(_0362_),
    .B2(_0364_),
    .C1(_0365_),
    ...
    .VPWR(VPWR),
    .X(_0366_));
 sky130_fd_sc_hd__and2_2 _0981_ (.A(net31),
    .B(_0145_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0367_));
 sky130_fd_sc_hd__or2_2 _0982_ (.A(\game.pixel_y[3] ),
    .B(_0147_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0368_));
 sky130_fd_sc_hd__a22o_2 _0983_ (.A1(\game.pixel_y[4] ),
    .A2(_0146_),
    .B1(_0147_),
    .B2(\game.pixel_y[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0369_));
 sky130_fd_sc_hd__a21o_2 _0984_ (.A1(_0307_),
    .A2(_0368_),
    .B1(_0369_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0370_));
 sky130_fd_sc_hd__o221a_2 _0985_ (.A1(net31),
    .A2(_0145_),
    .B1(_0146_),
    .B2(\game.pixel_y[4] ),
    .C1(_0370_),
    ...
    .VPWR(VPWR),
    .X(_0371_));
 sky130_fd_sc_hd__o22a_2 _0986_ (.A1(net30),
    .A2(_0144_),
    .B1(_0367_),
    .B2(_0371_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0372_));
 sky130_fd_sc_hd__a221o_2 _0987_ (.A1(net29),
    .A2(_0143_),
    .B1(_0144_),
    .B2(net30),
    .C1(_0372_),
    ...
    .VPWR(VPWR),
    .X(_0373_));
 sky130_fd_sc_hd__nor2_2 _0988_ (.A(_0316_),
    .B(_0317_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0374_));
 sky130_fd_sc_hd__o22a_2 _0989_ (.A1(net28),
    .A2(_0142_),
    .B1(_0143_),
    .B2(net29),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0375_));
 sky130_fd_sc_hd__o211a_2 _0990_ (.A1(_0130_),
    .A2(\game.proj_y[8] ),
    .B1(_0374_),
    .C1(_0375_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0376_));
 sky130_fd_sc_hd__a32o_2 _0991_ (.A1(net28),
    .A2(_0142_),
    .A3(_0374_),
    .B1(_0316_),
    .B2(_0298_),
    ...
    .VPWR(VPWR),
    .X(_0377_));
 sky130_fd_sc_hd__a21o_2 _0992_ (.A1(_0373_),
    .A2(_0376_),
    .B1(_0377_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0378_));
 sky130_fd_sc_hd__o211a_2 _0993_ (.A1(_0351_),
    .A2(_0353_),
    .B1(_0366_),
    .C1(_0378_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0379_));
 sky130_fd_sc_hd__o2111a_2 _0994_ (.A1(_0318_),
    .A2(_0320_),
    .B1(_0321_),
    .C1(_0379_),
    .D1(\game.proj_active ),
    ...
    .VPWR(VPWR),
    .X(uo_out[6]));
 sky130_fd_sc_hd__and4_2 _0995_ (.A(net24),
    .B(_0158_),
    .C(net22),
    .D(_0160_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0380_));
 sky130_fd_sc_hd__o21ai_2 _0996_ (.A1(\game.pixel_x[4] ),
    .A2(_0173_),
    .B1(_0380_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0381_));
 sky130_fd_sc_hd__a31o_2 _0997_ (.A1(net26),
    .A2(\game.pixel_x[4] ),
    .A3(net25),
    .B1(_0381_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(\game.hsync ));
 sky130_fd_sc_hd__and2_2 _0998_ (.A(\game.vsync_d ),
    .B(_0164_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0382_));
 sky130_fd_sc_hd__nand2_2 _0999_ (.A(\game.vsync_d ),
    .B(_0164_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0383_));
 sky130_fd_sc_hd__nand2b_2 _1000_ (.A_N(\game.player_x[10] ),
    ...
    .VPWR(VPWR),
    .Y(_0384_));
 sky130_fd_sc_hd__and4_2 _1001_ (.A(\gamepad.decoder.data_reg[3] ),
    ...
    .VPWR(VPWR),
    .X(_0385_));
 sky130_fd_sc_hd__and4_2 _1002_ (.A(\gamepad.decoder.data_reg[7] ),
    ...
    .VPWR(VPWR),
    .X(_0386_));
 sky130_fd_sc_hd__and4_2 _1003_ (.A(\gamepad.decoder.data_reg[11] ),
    .B(\gamepad.decoder.data_reg[10] ),
    ...
    .VPWR(VPWR),
    .X(_0387_));
 sky130_fd_sc_hd__and3_2 _1004_ (.A(_0385_),
    .B(_0386_),
    .C(_0387_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0388_));
 sky130_fd_sc_hd__a21oi_2 _1005_ (.A1(\game.player_x[1] ),
    .A2(\game.player_x[2] ),
    .B1(\game.player_x[3] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0389_));
 sky130_fd_sc_hd__nand2_2 _1006_ (.A(net39),
    .B(net41),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0390_));
 sky130_fd_sc_hd__a211oi_2 _1007_ (.A1(net40),
    .A2(net39),
    .B1(net38),
    .C1(\game.player_x[7] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0391_));
 sky130_fd_sc_hd__o21ai_2 _1008_ (.A1(_0389_),
    .A2(_0390_),
    .B1(_0391_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0392_));
 sky130_fd_sc_hd__a211o_2 _1009_ (.A1(net37),
    .A2(_0392_),
    .B1(_0388_),
    .C1(_0384_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0393_));
 sky130_fd_sc_hd__or4_2 _1010_ (.A(net37),
    .B(\game.player_x[10] ),
    .C(\game.player_x[3] ),
    .D(net41),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0394_));
 sky130_fd_sc_hd__a2111o_2 _1011_ (.A1(\game.player_x[0] ),
    .A2(\game.player_x[1] ),
    .B1(net38),
    .C1(\game.player_x[7] ),
    .D1(_0394_),
    ...
    .VPWR(VPWR),
    .X(_0395_));
 sky130_fd_sc_hd__or4_2 _1012_ (.A(net40),
    .B(net39),
    .C(\game.player_x[2] ),
    .D(_0395_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0396_));
 sky130_fd_sc_hd__nand3b_2 _1013_ (.A_N(_0388_),
    .B(_0396_),
    .C(\gamepad.decoder.data_reg[5] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0397_));
 sky130_fd_sc_hd__a21oi_2 _1014_ (.A1(net16),
    .A2(_0397_),
    .B1(_0383_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0398_));
 sky130_fd_sc_hd__inv_2 _1015_ (.A(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0399_));
 sky130_fd_sc_hd__xnor2_2 _1016_ (.A(_0114_),
    .B(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0011_));
 sky130_fd_sc_hd__or2_2 _1017_ (.A(_0135_),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0400_));
 sky130_fd_sc_hd__xnor2_2 _1018_ (.A(_0135_),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0401_));
 sky130_fd_sc_hd__xnor2_2 _1019_ (.A(\game.player_x[0] ),
    .B(_0401_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0402_));
 sky130_fd_sc_hd__mux2_1 _1020_ (.A0(\game.player_x[1] ),
    .A1(_0402_),
    .S(net14),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0012_));
 sky130_fd_sc_hd__and2_2 _1021_ (.A(\game.player_x[2] ),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0403_));
 sky130_fd_sc_hd__nor2_2 _1022_ (.A(\game.player_x[2] ),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0404_));
 sky130_fd_sc_hd__nor2_2 _1023_ (.A(_0403_),
    .B(_0404_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0405_));
 sky130_fd_sc_hd__o21ai_2 _1024_ (.A1(_0114_),
    .A2(_0401_),
    .B1(_0400_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0406_));
 sky130_fd_sc_hd__xor2_2 _1025_ (.A(_0405_),
    .B(_0406_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0407_));
 sky130_fd_sc_hd__mux2_1 _1026_ (.A0(\game.player_x[2] ),
    .A1(_0407_),
    .S(net13),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0013_));
 sky130_fd_sc_hd__xnor2_2 _1027_ (.A(_0139_),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0408_));
 sky130_fd_sc_hd__a21oi_2 _1028_ (.A1(_0405_),
    .A2(_0406_),
    .B1(_0403_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0409_));
 sky130_fd_sc_hd__xnor2_2 _1029_ (.A(_0408_),
    .B(_0409_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0410_));
 sky130_fd_sc_hd__mux2_1 _1030_ (.A0(\game.player_x[3] ),
    .A1(_0410_),
    .S(net13),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0014_));
 sky130_fd_sc_hd__and2_2 _1031_ (.A(net41),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0411_));
 sky130_fd_sc_hd__nor2_2 _1032_ (.A(\game.player_x[4] ),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0412_));
 sky130_fd_sc_hd__nor2_2 _1033_ (.A(_0411_),
    .B(_0412_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0413_));
 sky130_fd_sc_hd__o21a_2 _1034_ (.A1(\game.player_x[3] ),
    .A2(\game.player_x[2] ),
    .B1(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0414_));
 sky130_fd_sc_hd__a31o_2 _1035_ (.A1(_0405_),
    .A2(_0406_),
    .A3(_0408_),
    .B1(_0414_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0415_));
 sky130_fd_sc_hd__nand2_2 _1036_ (.A(_0413_),
    .B(_0415_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0416_));
 sky130_fd_sc_hd__o21a_2 _1037_ (.A1(_0413_),
    .A2(_0415_),
    .B1(net13),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0417_));
 sky130_fd_sc_hd__a22o_2 _1038_ (.A1(net148),
    .A2(_0399_),
    .B1(_0416_),
    .B2(_0417_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0015_));
 sky130_fd_sc_hd__xor2_2 _1039_ (.A(net40),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0418_));
 sky130_fd_sc_hd__a21oi_2 _1040_ (.A1(_0413_),
    .A2(_0415_),
    .B1(_0411_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0419_));
 sky130_fd_sc_hd__xnor2_2 _1041_ (.A(_0418_),
    .B(_0419_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0420_));
 sky130_fd_sc_hd__mux2_1 _1042_ (.A0(\game.player_x[5] ),
    .A1(_0420_),
    .S(net13),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0016_));
 sky130_fd_sc_hd__and2_2 _1043_ (.A(\game.player_x[6] ),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0421_));
 sky130_fd_sc_hd__nor2_2 _1044_ (.A(\game.player_x[6] ),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_2 _1045_ (.A(_0421_),
    ...
    .VPWR(VPWR),
    .Y(_0423_));
 sky130_fd_sc_hd__o21a_2 _1046_ (.A1(\game.player_x[5] ),
    .A2(\game.player_x[4] ),
    .B1(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0424_));
 sky130_fd_sc_hd__and2_2 _1047_ (.A(_0413_),
    .B(_0418_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0425_));
 sky130_fd_sc_hd__a21o_2 _1048_ (.A1(_0415_),
    .A2(_0425_),
    .B1(_0424_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0426_));
 sky130_fd_sc_hd__or2_2 _1049_ (.A(_0423_),
    .B(_0426_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0427_));
 sky130_fd_sc_hd__a21oi_2 _1050_ (.A1(_0423_),
    .A2(_0426_),
    .B1(_0399_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0428_));
 sky130_fd_sc_hd__a22o_2 _1051_ (.A1(net144),
    .A2(_0399_),
    .B1(_0427_),
    .B2(_0428_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0017_));
 sky130_fd_sc_hd__xnor2_2 _1052_ (.A(_0138_),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0429_));
 sky130_fd_sc_hd__a21oi_2 _1053_ (.A1(_0423_),
    .A2(_0426_),
    .B1(_0421_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0430_));
 sky130_fd_sc_hd__xnor2_2 _1054_ (.A(_0429_),
    .B(_0430_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0431_));
 sky130_fd_sc_hd__mux2_1 _1055_ (.A0(\game.player_x[7] ),
    .A1(_0431_),
    .S(net14),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0018_));
 sky130_fd_sc_hd__and2_2 _1056_ (.A(net38),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0432_));
 sky130_fd_sc_hd__or2_2 _1057_ (.A(net38),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0433_));
 sky130_fd_sc_hd__nand2b_2 _1058_ (.A_N(_0432_),
    .B(_0433_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0434_));
 sky130_fd_sc_hd__and2_2 _1059_ (.A(_0423_),
    .B(_0429_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0435_));
 sky130_fd_sc_hd__a211o_2 _1060_ (.A1(\game.player_x[7] ),
    .A2(net16),
    .B1(_0421_),
    .C1(_0424_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0436_));
 sky130_fd_sc_hd__a31o_2 _1061_ (.A1(_0415_),
    .A2(_0425_),
    .A3(_0435_),
    .B1(_0436_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0437_));
 sky130_fd_sc_hd__xnor2_2 _1062_ (.A(_0434_),
    .B(_0437_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0438_));
 sky130_fd_sc_hd__mux2_1 _1063_ (.A0(net38),
    .A1(_0438_),
    .S(net14),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0019_));
 sky130_fd_sc_hd__nand2_2 _1064_ (.A(net37),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0439_));
 sky130_fd_sc_hd__o31a_2 _1065_ (.A1(net37),
    .A2(_0384_),
    .A3(_0388_),
    .B1(_0439_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0440_));
 sky130_fd_sc_hd__a21oi_2 _1066_ (.A1(_0433_),
    .A2(_0437_),
    .B1(_0432_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0441_));
 sky130_fd_sc_hd__xnor2_2 _1067_ (.A(_0440_),
    .B(_0441_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_1 _1068_ (.A0(net138),
    ...
    .VPWR(VPWR),
    .X(_0020_));
 sky130_fd_sc_hd__o21a_2 _1069_ (.A1(\game.player_x[9] ),
    .A2(\game.player_x[8] ),
    .B1(net16),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0443_));
 sky130_fd_sc_hd__o31a_2 _1070_ (.A1(_0399_),
    .A2(_0437_),
    .A3(_0443_),
    .B1(\game.player_x[10] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0021_));
 sky130_fd_sc_hd__nor4_2 _1071_ (.A(\game.wait_cnt[0] ),
    .B(\game.wait_cnt[1] ),
    .C(\game.wait_cnt[2] ),
    .D(_0383_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0444_));
 sky130_fd_sc_hd__or4_2 _1072_ (.A(\game.alien_x[8] ),
    .B(\game.alien_x[7] ),
    .C(\game.alien_x[9] ),
    .D(\game.alien_x[10] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0445_));
 sky130_fd_sc_hd__a31o_2 _1073_ (.A1(\game.alien_x[3] ),
    .A2(\game.alien_x[2] ),
    .A3(\game.alien_x[1] ),
    .B1(net36),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0446_));
 sky130_fd_sc_hd__a31o_2 _1074_ (.A1(net34),
    .A2(net35),
    .A3(_0446_),
    .B1(_0445_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0447_));
 sky130_fd_sc_hd__or4_2 _1075_ (.A(net34),
    .B(net35),
    .C(net36),
    .D(_0445_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0448_));
 sky130_fd_sc_hd__a21oi_2 _1076_ (.A1(\game.alien_x[1] ),
    .A2(\game.alien_x[0] ),
    .B1(\game.alien_x[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0449_));
 sky130_fd_sc_hd__nand2_2 _1077_ (.A(\game.alien_x[3] ),
    .B(net33),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0450_));
 sky130_fd_sc_hd__inv_2 _1078_ (.A(_0450_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0451_));
 sky130_fd_sc_hd__o2bb2a_2 _1079_ (.A1_N(net33),
    .A2_N(_0448_),
    .B1(_0449_),
    .B2(_0450_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0452_));
 sky130_fd_sc_hd__o21ai_2 _1080_ (.A1(net32),
    .A2(_0447_),
    .B1(_0452_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0453_));
 sky130_fd_sc_hd__nand2_2 _1081_ (.A(net12),
    .B(_0453_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0454_));
 sky130_fd_sc_hd__xnor2_2 _1082_ (.A(net153),
    .B(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0022_));
 sky130_fd_sc_hd__or2_2 _1083_ (.A(\game.alien_x[1] ),
    .B(net33),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0455_));
 sky130_fd_sc_hd__nand2_2 _1084_ (.A(\game.alien_x[1] ),
    .B(net33),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0456_));
 sky130_fd_sc_hd__nand2_2 _1085_ (.A(_0455_),
    .B(_0456_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0457_));
 sky130_fd_sc_hd__xnor2_2 _1086_ (.A(\game.alien_x[0] ),
    .B(_0457_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0458_));
 sky130_fd_sc_hd__mux2_1 _1087_ (.A0(_0458_),
    .A1(\game.alien_x[1] ),
    .S(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0023_));
 sky130_fd_sc_hd__or2_2 _1088_ (.A(\game.alien_x[2] ),
    .B(net33),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0459_));
 sky130_fd_sc_hd__nand2_2 _1089_ (.A(\game.alien_x[2] ),
    .B(net33),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0460_));
 sky130_fd_sc_hd__nand2_2 _1090_ (.A(_0459_),
    .B(_0460_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0461_));
 sky130_fd_sc_hd__o21ai_2 _1091_ (.A1(_0122_),
    .A2(_0457_),
    .B1(_0456_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0462_));
 sky130_fd_sc_hd__xnor2_2 _1092_ (.A(_0461_),
    .B(_0462_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0463_));
 sky130_fd_sc_hd__mux2_1 _1093_ (.A0(_0463_),
    .A1(\game.alien_x[2] ),
    .S(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0024_));
 sky130_fd_sc_hd__nor2_2 _1094_ (.A(\game.alien_x[3] ),
    .B(net33),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0464_));
 sky130_fd_sc_hd__nor2_2 _1095_ (.A(_0451_),
    .B(_0464_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0465_));
 sky130_fd_sc_hd__a21boi_2 _1096_ (.A1(_0459_),
    .A2(_0462_),
    .B1_N(_0460_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0466_));
 sky130_fd_sc_hd__xnor2_2 _1097_ (.A(_0465_),
    .B(_0466_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0467_));
 sky130_fd_sc_hd__mux2_1 _1098_ (.A0(_0467_),
    .A1(\game.alien_x[3] ),
    .S(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0025_));
 sky130_fd_sc_hd__and2_2 _1099_ (.A(net36),
    .B(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0468_));
 sky130_fd_sc_hd__nor2_2 _1100_ (.A(net36),
    .B(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0469_));
 sky130_fd_sc_hd__o21a_2 _1101_ (.A1(_0464_),
    .A2(_0466_),
    .B1(_0450_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0470_));
 sky130_fd_sc_hd__nor3_2 _1102_ (.A(_0468_),
    .B(_0469_),
    .C(_0470_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0471_));
 sky130_fd_sc_hd__o21a_2 _1103_ (.A1(_0468_),
    .A2(_0469_),
    .B1(_0470_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0472_));
 sky130_fd_sc_hd__nor2_2 _1104_ (.A(_0471_),
    .B(_0472_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0473_));
 sky130_fd_sc_hd__mux2_1 _1105_ (.A0(_0473_),
    .A1(net36),
    .S(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0026_));
 sky130_fd_sc_hd__or2_2 _1106_ (.A(_0468_),
    .B(_0471_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0474_));
 sky130_fd_sc_hd__xnor2_2 _1107_ (.A(net35),
    .B(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0475_));
 sky130_fd_sc_hd__xnor2_2 _1108_ (.A(_0474_),
    .B(_0475_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0476_));
 sky130_fd_sc_hd__mux2_1 _1109_ (.A0(_0476_),
    .A1(net35),
    .S(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0027_));
 sky130_fd_sc_hd__xnor2_2 _1110_ (.A(net34),
    .B(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0477_));
 sky130_fd_sc_hd__or4_2 _1111_ (.A(_0468_),
    .B(_0469_),
    .C(_0470_),
    .D(_0475_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0478_));
 sky130_fd_sc_hd__o21ai_2 _1112_ (.A1(net35),
    .A2(net36),
    .B1(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0479_));
 sky130_fd_sc_hd__a21oi_2 _1113_ (.A1(_0478_),
    .A2(_0479_),
    .B1(_0477_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0480_));
 sky130_fd_sc_hd__and3_2 _1114_ (.A(_0477_),
    .B(_0478_),
    .C(_0479_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0481_));
 sky130_fd_sc_hd__nand2_2 _1115_ (.A(net34),
    .B(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0482_));
 sky130_fd_sc_hd__o31ai_2 _1116_ (.A1(net7),
    .A2(_0480_),
    .A3(_0481_),
    .B1(_0482_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0028_));
 sky130_fd_sc_hd__xnor2_2 _1117_ (.A(\game.alien_x[7] ),
    .B(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0483_));
 sky130_fd_sc_hd__a21o_2 _1118_ (.A1(net34),
    .A2(net32),
    .B1(_0480_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0484_));
 sky130_fd_sc_hd__xnor2_2 _1119_ (.A(_0483_),
    .B(_0484_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0485_));
 sky130_fd_sc_hd__mux2_1 _1120_ (.A0(_0485_),
    .A1(\game.alien_x[7] ),
    .S(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0029_));
 sky130_fd_sc_hd__or2_2 _1121_ (.A(\game.alien_x[8] ),
    .B(net33),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0486_));
 sky130_fd_sc_hd__nand2_2 _1122_ (.A(\game.alien_x[8] ),
    .B(net33),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0487_));
 sky130_fd_sc_hd__nand2_2 _1123_ (.A(_0486_),
    .B(_0487_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0488_));
 sky130_fd_sc_hd__or2_2 _1124_ (.A(_0477_),
    .B(_0483_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0489_));
 sky130_fd_sc_hd__o41a_2 _1125_ (.A1(net34),
    .A2(net35),
    .A3(net36),
    .A4(\game.alien_x[7] ),
    .B1(net32),
    ...
    .VPWR(VPWR),
    .X(_0490_));
 sky130_fd_sc_hd__o21bai_2 _1126_ (.A1(_0478_),
    .A2(_0489_),
    .B1_N(_0490_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0491_));
 sky130_fd_sc_hd__xnor2_2 _1127_ (.A(_0488_),
    .B(_0491_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0492_));
 sky130_fd_sc_hd__mux2_1 _1128_ (.A0(_0492_),
    .A1(\game.alien_x[8] ),
    .S(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0030_));
 sky130_fd_sc_hd__and2_2 _1129_ (.A(net33),
    .B(\game.alien_x[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0493_));
 sky130_fd_sc_hd__nor2_2 _1130_ (.A(\game.alien_dir ),
    .B(\game.alien_x[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0494_));
 sky130_fd_sc_hd__or2_2 _1131_ (.A(_0493_),
    .B(_0494_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0495_));
 sky130_fd_sc_hd__a21bo_2 _1132_ (.A1(_0486_),
    .A2(_0491_),
    .B1_N(_0487_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0496_));
 sky130_fd_sc_hd__xnor2_2 _1133_ (.A(_0495_),
    .B(_0496_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0497_));
 sky130_fd_sc_hd__mux2_1 _1134_ (.A0(_0497_),
    .A1(\game.alien_x[9] ),
    .S(_0454_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0031_));
 sky130_fd_sc_hd__and2b_2 _1135_ (.A_N(_0494_),
    .B(_0496_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0498_));
 sky130_fd_sc_hd__o31a_2 _1136_ (.A1(_0454_),
    .A2(_0493_),
    .A3(_0498_),
    .B1(\game.alien_x[10] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0032_));
 sky130_fd_sc_hd__nand2_2 _1137_ (.A(net12),
    .B(_0452_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0499_));
 sky130_fd_sc_hd__o22a_2 _1138_ (.A1(net145),
    .A2(_0444_),
    .B1(_0447_),
    .B2(_0499_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0033_));
 sky130_fd_sc_hd__nor2_2 _1139_ (.A(_0124_),
    .B(\game.alien_x[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0500_));
 sky130_fd_sc_hd__and2_2 _1140_ (.A(_0124_),
    .B(\game.alien_x[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0501_));
 sky130_fd_sc_hd__nor2_2 _1141_ (.A(_0500_),
    .B(_0501_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0502_));
 sky130_fd_sc_hd__nor2_2 _1142_ (.A(\game.alien_x[7] ),
    .B(_0125_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0503_));
 sky130_fd_sc_hd__nand2_2 _1143_ (.A(\game.alien_x[7] ),
    .B(_0125_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0504_));
 sky130_fd_sc_hd__nand2_2 _1144_ (.A(net34),
    .B(_0115_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0505_));
 sky130_fd_sc_hd__and2b_2 _1145_ (.A_N(\game.proj_x[5] ),
    .B(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0506_));
 sky130_fd_sc_hd__and2b_2 _1146_ (.A_N(\game.alien_x[5] ),
    .B(\game.proj_x[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0507_));
 sky130_fd_sc_hd__or2_2 _1147_ (.A(net36),
    .B(_0117_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0508_));
 sky130_fd_sc_hd__inv_2 _1148_ (.A(_0508_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0509_));
 sky130_fd_sc_hd__a211o_2 _1149_ (.A1(_0121_),
    .A2(\game.proj_x[1] ),
    .B1(_0122_),
    .C1(\game.proj_x[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0510_));
 sky130_fd_sc_hd__nand2b_2 _1150_ (.A_N(\game.proj_x[3] ),
    .B(\game.alien_x[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0511_));
 sky130_fd_sc_hd__nand2_2 _1151_ (.A(\game.alien_x[4] ),
    .B(_0117_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0512_));
 sky130_fd_sc_hd__o221a_2 _1152_ (.A1(_0120_),
    .A2(\game.proj_x[2] ),
    .B1(_0121_),
    .B2(\game.proj_x[1] ),
    .C1(_0511_),
    ...
    .VPWR(VPWR),
    .X(_0513_));
 sky130_fd_sc_hd__and3_2 _1153_ (.A(_0120_),
    .B(\game.proj_x[2] ),
    .C(_0511_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0514_));
 sky130_fd_sc_hd__a221o_2 _1154_ (.A1(_0118_),
    .A2(\game.proj_x[3] ),
    .B1(_0510_),
    .B2(_0513_),
    .C1(_0514_),
    ...
    .VPWR(VPWR),
    .X(_0515_));
 sky130_fd_sc_hd__o21ai_2 _1155_ (.A1(_0509_),
    .A2(_0515_),
    .B1(_0512_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0516_));
 sky130_fd_sc_hd__nor2_2 _1156_ (.A(_0506_),
    .B(_0507_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0517_));
 sky130_fd_sc_hd__and3_2 _1157_ (.A(_0508_),
    .B(_0512_),
    .C(_0517_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0518_));
 sky130_fd_sc_hd__and2_2 _1158_ (.A(_0515_),
    .B(_0518_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0519_));
 sky130_fd_sc_hd__o21bai_2 _1159_ (.A1(_0506_),
    .A2(_0508_),
    .B1_N(_0507_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0520_));
 sky130_fd_sc_hd__a21o_2 _1160_ (.A1(_0515_),
    .A2(_0518_),
    .B1(_0520_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_2 _1161_ (.A(net34),
    ...
    .VPWR(VPWR),
    .Y(_0522_));
 sky130_fd_sc_hd__inv_2 _1162_ (.A(_0522_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0523_));
 sky130_fd_sc_hd__or3b_2 _1163_ (.A(\game.proj_x[6] ),
    .B(_0503_),
    .C_N(\game.alien_x[6] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0524_));
 sky130_fd_sc_hd__a21oi_2 _1164_ (.A1(_0504_),
    .A2(_0522_),
    .B1(_0503_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0525_));
 sky130_fd_sc_hd__inv_2 _1165_ (.A(_0525_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0526_));
 sky130_fd_sc_hd__o211a_2 _1166_ (.A1(_0521_),
    .A2(_0526_),
    .B1(_0524_),
    .C1(_0504_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0527_));
 sky130_fd_sc_hd__o2111a_2 _1167_ (.A1(_0521_),
    .A2(_0526_),
    .B1(_0524_),
    .C1(_0502_),
    .D1(_0504_),
    ...
    .VPWR(VPWR),
    .X(_0528_));
 sky130_fd_sc_hd__xor2_2 _1168_ (.A(_0502_),
    .B(_0527_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0529_));
 sky130_fd_sc_hd__inv_2 _1169_ (.A(_0529_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0530_));
 sky130_fd_sc_hd__and2_2 _1170_ (.A(_0505_),
    .B(_0523_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0531_));
 sky130_fd_sc_hd__xnor2_2 _1171_ (.A(_0521_),
    .B(_0531_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0532_));
 sky130_fd_sc_hd__and2b_2 _1172_ (.A_N(_0503_),
    .B(_0504_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0533_));
 sky130_fd_sc_hd__a211o_2 _1173_ (.A1(_0505_),
    .A2(_0521_),
    .B1(_0522_),
    .C1(_0533_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0534_));
 sky130_fd_sc_hd__o311ai_2 _1174_ (.A1(_0519_),
    .A2(_0520_),
    .A3(_0522_),
    .B1(_0533_),
    .C1(_0505_),
    ...
    .VPWR(VPWR),
    .Y(_0535_));
 sky130_fd_sc_hd__nand2_2 _1175_ (.A(_0534_),
    .B(_0535_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0536_));
 sky130_fd_sc_hd__nand2_2 _1176_ (.A(_0532_),
    .B(_0536_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0537_));
 sky130_fd_sc_hd__nand2_2 _1177_ (.A(_0140_),
    .B(\game.proj_x[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0538_));
 sky130_fd_sc_hd__nand2_2 _1178_ (.A(\game.alien_x[9] ),
    .B(_0152_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0539_));
 sky130_fd_sc_hd__o211ai_2 _1179_ (.A1(_0500_),
    .A2(_0528_),
    .B1(_0538_),
    .C1(_0539_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0540_));
 sky130_fd_sc_hd__nand2_2 _1180_ (.A(_0538_),
    .B(_0540_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0541_));
 sky130_fd_sc_hd__xor2_2 _1181_ (.A(\game.alien_x[10] ),
    .B(\game.proj_x[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0542_));
 sky130_fd_sc_hd__xnor2_2 _1182_ (.A(_0541_),
    .B(_0542_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0543_));
 sky130_fd_sc_hd__or3b_2 _1183_ (.A(_0532_),
    .B(_0536_),
    .C_N(\game.aliens_alive[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0544_));
 sky130_fd_sc_hd__a21o_2 _1184_ (.A1(_0534_),
    .A2(_0535_),
    .B1(_0532_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0545_));
 sky130_fd_sc_hd__mux2_1 _1185_ (.A0(\game.aliens_alive[5] ),
    .A1(\game.aliens_alive[4] ),
    .S(_0532_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0546_));
 sky130_fd_sc_hd__and3_2 _1186_ (.A(_0532_),
    .B(_0534_),
    .C(_0535_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0547_));
 sky130_fd_sc_hd__inv_2 _1187_ (.A(_0547_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0548_));
 sky130_fd_sc_hd__a22oi_2 _1188_ (.A1(_0536_),
    .A2(_0546_),
    .B1(_0547_),
    .B2(\game.aliens_alive[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0549_));
 sky130_fd_sc_hd__and3_2 _1189_ (.A(_0529_),
    .B(_0544_),
    .C(_0549_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0550_));
 sky130_fd_sc_hd__and4b_2 _1190_ (.A_N(_0532_),
    .B(_0534_),
    .C(_0535_),
    .D(\game.aliens_alive[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0551_));
 sky130_fd_sc_hd__mux2_1 _1191_ (.A0(\game.aliens_alive[1] ),
    .A1(\game.aliens_alive[0] ),
    .S(_0532_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0552_));
 sky130_fd_sc_hd__nand2_2 _1192_ (.A(_0536_),
    .B(_0552_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0553_));
 sky130_fd_sc_hd__a21oi_2 _1193_ (.A1(\game.aliens_alive[2] ),
    .A2(_0547_),
    .B1(_0551_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0554_));
 sky130_fd_sc_hd__a211o_2 _1194_ (.A1(_0538_),
    .A2(_0539_),
    .B1(_0500_),
    .C1(_0528_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0555_));
 sky130_fd_sc_hd__nor2_2 _1195_ (.A(net21),
    .B(\game.proj_y[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0556_));
 sky130_fd_sc_hd__and2_2 _1196_ (.A(net21),
    .B(\game.proj_y[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0557_));
 sky130_fd_sc_hd__nand2_2 _1197_ (.A(\game.alien_y[5] ),
    .B(\game.proj_y[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0558_));
 sky130_fd_sc_hd__and4_2 _1198_ (.A(\game.proj_y[4] ),
    .B(\game.proj_y[3] ),
    .C(\game.proj_y[1] ),
    .D(\game.proj_y[2] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0559_));
 sky130_fd_sc_hd__o21ai_2 _1199_ (.A1(_0556_),
    .A2(_0557_),
    .B1(_0559_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0560_));
 sky130_fd_sc_hd__xnor2_2 _1200_ (.A(\game.proj_y[6] ),
    .B(_0219_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0561_));
 sky130_fd_sc_hd__a22o_2 _1201_ (.A1(\game.alien_y[7] ),
    .A2(_0143_),
    .B1(_0144_),
    .B2(\game.alien_y[6] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0562_));
 sky130_fd_sc_hd__o32a_2 _1202_ (.A1(_0556_),
    .A2(_0557_),
    .A3(_0561_),
    .B1(_0144_),
    .B2(\game.alien_y[6] ),
    ...
    .VPWR(VPWR),
    .X(_0563_));
 sky130_fd_sc_hd__a21o_2 _1203_ (.A1(_0560_),
    .A2(_0563_),
    .B1(_0562_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0564_));
 sky130_fd_sc_hd__o221a_2 _1204_ (.A1(\game.alien_y[8] ),
    .A2(_0142_),
    .B1(_0143_),
    .B2(\game.alien_y[7] ),
    .C1(_0564_),
    ...
    .VPWR(VPWR),
    .X(_0565_));
 sky130_fd_sc_hd__and2b_2 _1205_ (.A_N(\game.proj_y[9] ),
    .B(\game.alien_y[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0566_));
 sky130_fd_sc_hd__nand2b_2 _1206_ (.A_N(\game.alien_y[9] ),
    .B(\game.proj_y[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0567_));
 sky130_fd_sc_hd__a21bo_2 _1207_ (.A1(\game.alien_y[8] ),
    .A2(_0142_),
    .B1_N(_0567_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0568_));
 sky130_fd_sc_hd__o32a_2 _1208_ (.A1(_0565_),
    .A2(_0566_),
    .A3(_0568_),
    .B1(_0567_),
    .B2(_0237_),
    ...
    .VPWR(VPWR),
    .X(_0569_));
 sky130_fd_sc_hd__xnor2_2 _1209_ (.A(_0516_),
    .B(_0517_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0570_));
 sky130_fd_sc_hd__or4b_2 _1210_ (.A(_0556_),
    .B(_0561_),
    .C(_0557_),
    .D_N(_0559_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0571_));
 sky130_fd_sc_hd__a22oi_2 _1211_ (.A1(\game.proj_y[6] ),
    .A2(_0219_),
    .B1(_0234_),
    .B2(\game.proj_y[7] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0572_));
 sky130_fd_sc_hd__o211ai_2 _1212_ (.A1(_0558_),
    .A2(_0561_),
    .B1(_0571_),
    .C1(_0572_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0573_));
 sky130_fd_sc_hd__o22a_2 _1213_ (.A1(\game.proj_y[7] ),
    .A2(_0234_),
    .B1(_0239_),
    .B2(\game.proj_y[8] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0574_));
 sky130_fd_sc_hd__a22o_2 _1214_ (.A1(\game.proj_y[8] ),
    .A2(_0239_),
    .B1(_0573_),
    .B2(_0574_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0575_));
 sky130_fd_sc_hd__xor2_2 _1215_ (.A(\game.proj_y[9] ),
    .B(_0241_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0576_));
 sky130_fd_sc_hd__a211o_2 _1216_ (.A1(_0575_),
    .A2(_0576_),
    .B1(_0141_),
    .C1(_0570_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0577_));
 sky130_fd_sc_hd__a211o_2 _1217_ (.A1(_0540_),
    .A2(_0555_),
    .B1(_0569_),
    .C1(_0577_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0578_));
 sky130_fd_sc_hd__a31o_2 _1218_ (.A1(_0530_),
    .A2(_0553_),
    .A3(_0554_),
    .B1(_0578_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0579_));
 sky130_fd_sc_hd__or3_2 _1219_ (.A(_0543_),
    .B(_0550_),
    .C(_0579_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0580_));
 sky130_fd_sc_hd__or4_2 _1220_ (.A(_0383_),
    .B(_0543_),
    .C(_0550_),
    .D(_0579_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0581_));
 sky130_fd_sc_hd__o31a_2 _1221_ (.A1(_0529_),
    .A2(_0537_),
    .A3(_0581_),
    .B1(net133),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0034_));
 sky130_fd_sc_hd__o31a_2 _1222_ (.A1(_0529_),
    .A2(_0545_),
    .A3(_0581_),
    .B1(net134),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0035_));
 sky130_fd_sc_hd__o31a_2 _1223_ (.A1(_0529_),
    .A2(_0548_),
    .A3(_0581_),
    .B1(net136),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0036_));
 sky130_fd_sc_hd__o41a_2 _1224_ (.A1(_0529_),
    .A2(_0532_),
    .A3(_0536_),
    .A4(_0581_),
    .B1(net132),
    ...
    .VPWR(VPWR),
    .X(_0037_));
 sky130_fd_sc_hd__o31a_2 _1225_ (.A1(_0530_),
    .A2(_0537_),
    .A3(_0581_),
    .B1(net128),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0038_));
 sky130_fd_sc_hd__o31a_2 _1226_ (.A1(_0530_),
    .A2(_0545_),
    .A3(_0581_),
    .B1(net130),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0039_));
 sky130_fd_sc_hd__o31a_2 _1227_ (.A1(_0530_),
    .A2(_0548_),
    .A3(_0581_),
    .B1(net131),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0040_));
 sky130_fd_sc_hd__o41a_2 _1228_ (.A1(_0530_),
    .A2(_0532_),
    .A3(_0536_),
    .A4(_0581_),
    .B1(net126),
    ...
    .VPWR(VPWR),
    .X(_0041_));
 sky130_fd_sc_hd__nor2_2 _1229_ (.A(\gamepad.decoder.data_reg[11] ),
    .B(\gamepad.decoder.data_reg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0582_));
 sky130_fd_sc_hd__nor4_2 _1230_ (.A(\game.proj_active ),
    .B(_0383_),
    .C(_0388_),
    .D(_0582_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0583_));
 sky130_fd_sc_hd__or4_2 _1231_ (.A(\game.proj_active ),
    .B(_0383_),
    .C(_0388_),
    .D(_0582_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0584_));
 sky130_fd_sc_hd__mux2_1 _1232_ (.A0(net142),
    .A1(\game.player_x[0] ),
    .S(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0042_));
 sky130_fd_sc_hd__mux2_1 _1233_ (.A0(\game.proj_x[1] ),
    .A1(_0135_),
    .S(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0043_));
 sky130_fd_sc_hd__xor2_2 _1234_ (.A(\game.player_x[1] ),
    .B(\game.player_x[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0585_));
 sky130_fd_sc_hd__mux2_1 _1235_ (.A0(\game.proj_x[2] ),
    .A1(_0585_),
    .S(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0044_));
 sky130_fd_sc_hd__and3_2 _1236_ (.A(\game.player_x[1] ),
    .B(\game.player_x[3] ),
    .C(\game.player_x[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0586_));
 sky130_fd_sc_hd__nor2_2 _1237_ (.A(_0389_),
    .B(_0586_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0587_));
 sky130_fd_sc_hd__mux2_1 _1238_ (.A0(\game.proj_x[3] ),
    .A1(_0587_),
    .S(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0045_));
 sky130_fd_sc_hd__or2_2 _1239_ (.A(net41),
    .B(_0586_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0588_));
 sky130_fd_sc_hd__a21oi_2 _1240_ (.A1(net41),
    .A2(_0586_),
    .B1(_0584_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0589_));
 sky130_fd_sc_hd__o2bb2a_2 _1241_ (.A1_N(_0588_),
    .A2_N(_0589_),
    .B1(\game.proj_x[4] ),
    .B2(net9),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0046_));
 sky130_fd_sc_hd__xor2_2 _1242_ (.A(net40),
    .B(_0588_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0590_));
 sky130_fd_sc_hd__mux2_1 _1243_ (.A0(\game.proj_x[5] ),
    .A1(_0590_),
    .S(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0047_));
 sky130_fd_sc_hd__and3_2 _1244_ (.A(net40),
    .B(net39),
    .C(_0588_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0591_));
 sky130_fd_sc_hd__a21oi_2 _1245_ (.A1(net40),
    .A2(_0588_),
    .B1(net39),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0592_));
 sky130_fd_sc_hd__or3_2 _1246_ (.A(_0584_),
    .B(_0591_),
    .C(_0592_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0593_));
 sky130_fd_sc_hd__o21ai_2 _1247_ (.A1(_0115_),
    .A2(net8),
    .B1(_0593_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0048_));
 sky130_fd_sc_hd__xnor2_2 _1248_ (.A(_0138_),
    .B(_0591_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0594_));
 sky130_fd_sc_hd__mux2_1 _1249_ (.A0(net151),
    .A1(_0594_),
    .S(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0049_));
 sky130_fd_sc_hd__a21oi_2 _1250_ (.A1(\game.player_x[7] ),
    .A2(_0591_),
    .B1(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0595_));
 sky130_fd_sc_hd__and3_2 _1251_ (.A(net38),
    .B(\game.player_x[7] ),
    .C(_0591_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0596_));
 sky130_fd_sc_hd__or3_2 _1252_ (.A(_0584_),
    .B(_0595_),
    .C(_0596_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0597_));
 sky130_fd_sc_hd__o21ai_2 _1253_ (.A1(_0124_),
    .A2(net8),
    .B1(_0597_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0050_));
 sky130_fd_sc_hd__xnor2_2 _1254_ (.A(_0136_),
    .B(_0596_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0598_));
 sky130_fd_sc_hd__mux2_1 _1255_ (.A0(\game.proj_x[9] ),
    .A1(_0598_),
    .S(net8),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0051_));
 sky130_fd_sc_hd__and3_2 _1256_ (.A(net37),
    .B(\game.player_x[10] ),
    .C(_0596_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0599_));
 sky130_fd_sc_hd__a21oi_2 _1257_ (.A1(net37),
    .A2(_0596_),
    .B1(\game.player_x[10] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0600_));
 sky130_fd_sc_hd__or3_2 _1258_ (.A(_0584_),
    .B(_0599_),
    .C(_0600_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0601_));
 sky130_fd_sc_hd__o21ai_2 _1259_ (.A1(_0151_),
    .A2(net10),
    .B1(_0601_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0052_));
 sky130_fd_sc_hd__or4_2 _1260_ (.A(\game.proj_y[7] ),
    .B(\game.proj_y[6] ),
    .C(\game.proj_y[5] ),
    .D(_0302_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0602_));
 sky130_fd_sc_hd__o21a_2 _1261_ (.A1(\game.proj_y[1] ),
    .A2(\game.proj_y[0] ),
    .B1(\game.proj_y[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0603_));
 sky130_fd_sc_hd__or4_2 _1262_ (.A(\game.proj_y[8] ),
    .B(\game.proj_y[9] ),
    .C(_0602_),
    .D(_0603_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0604_));
 sky130_fd_sc_hd__and3_2 _1263_ (.A(\game.proj_active ),
    .B(_0382_),
    .C(_0604_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0605_));
 sky130_fd_sc_hd__a221o_2 _1264_ (.A1(\game.proj_active ),
    .A2(_0383_),
    .B1(_0580_),
    .B2(_0605_),
    .C1(net11),
    ...
    .VPWR(VPWR),
    .X(_0053_));
 sky130_fd_sc_hd__xnor2_2 _1265_ (.A(net139),
    .B(_0383_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0054_));
 sky130_fd_sc_hd__and3_2 _1266_ (.A(\game.wait_cnt[0] ),
    .B(\game.wait_cnt[1] ),
    .C(_0382_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0606_));
 sky130_fd_sc_hd__a21oi_2 _1267_ (.A1(net154),
    .A2(_0382_),
    .B1(net137),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0607_));
 sky130_fd_sc_hd__nor2_2 _1268_ (.A(_0606_),
    .B(_0607_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0055_));
 sky130_fd_sc_hd__xor2_2 _1269_ (.A(net135),
    .B(_0606_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0056_));
 sky130_fd_sc_hd__and2_2 _1270_ (.A(\game.pixel_y[0] ),
    .B(_0175_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0608_));
 sky130_fd_sc_hd__or4_2 _1271_ (.A(net30),
    .B(\game.pixel_y[1] ),
    .C(\game.pixel_y[0] ),
    .D(_0134_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0609_));
 sky130_fd_sc_hd__nand2_2 _1272_ (.A(_0130_),
    .B(_0292_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0610_));
 sky130_fd_sc_hd__or4_2 _1273_ (.A(net29),
    .B(_0216_),
    .C(_0609_),
    .D(_0610_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0611_));
 sky130_fd_sc_hd__inv_2 _1274_ (.A(_0611_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0612_));
 sky130_fd_sc_hd__nand2_2 _1275_ (.A(_0175_),
    .B(_0612_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0613_));
 sky130_fd_sc_hd__a21oi_2 _1276_ (.A1(_0175_),
    .A2(_0611_),
    .B1(net146),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0614_));
 sky130_fd_sc_hd__and4_2 _1277_ (.A(\game.pixel_y[0] ),
    .B(_0169_),
    .C(_0172_),
    .D(_0174_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0615_));
 sky130_fd_sc_hd__nor2_2 _1278_ (.A(_0608_),
    .B(_0614_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0057_));
 sky130_fd_sc_hd__nor2_2 _1279_ (.A(\game.pixel_y[1] ),
    .B(_0615_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0616_));
 sky130_fd_sc_hd__and3_2 _1280_ (.A(\game.pixel_y[1] ),
    .B(\game.pixel_y[0] ),
    .C(_0175_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0617_));
 sky130_fd_sc_hd__nor2_2 _1281_ (.A(_0616_),
    .B(_0617_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0058_));
 sky130_fd_sc_hd__o21ai_2 _1282_ (.A1(\game.pixel_y[2] ),
    .A2(_0617_),
    .B1(_0613_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0618_));
 sky130_fd_sc_hd__and2_2 _1283_ (.A(\game.pixel_y[2] ),
    .B(_0617_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0619_));
 sky130_fd_sc_hd__nor2_2 _1284_ (.A(_0618_),
    .B(_0619_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0059_));
 sky130_fd_sc_hd__nand2b_2 _1285_ (.A_N(_0216_),
    .B(_0617_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0620_));
 sky130_fd_sc_hd__and4_2 _1286_ (.A(\game.pixel_y[3] ),
    .B(\game.pixel_y[1] ),
    .C(\game.pixel_y[2] ),
    .D(_0615_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0621_));
 sky130_fd_sc_hd__o211a_2 _1287_ (.A1(\game.pixel_y[3] ),
    .A2(_0619_),
    .B1(_0620_),
    .C1(_0613_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0060_));
 sky130_fd_sc_hd__a22oi_2 _1288_ (.A1(_0217_),
    .A2(_0608_),
    .B1(_0620_),
    .B2(_0133_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0061_));
 sky130_fd_sc_hd__a21oi_2 _1289_ (.A1(\game.pixel_y[4] ),
    .A2(_0621_),
    .B1(net147),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0622_));
 sky130_fd_sc_hd__and3_2 _1290_ (.A(\game.pixel_y[5] ),
    .B(\game.pixel_y[4] ),
    .C(_0621_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0623_));
 sky130_fd_sc_hd__nor2_2 _1291_ (.A(_0622_),
    .B(_0623_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0062_));
 sky130_fd_sc_hd__nor2_2 _1292_ (.A(net30),
    .B(_0623_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0624_));
 sky130_fd_sc_hd__and4_2 _1293_ (.A(\game.pixel_y[5] ),
    .B(\game.pixel_y[6] ),
    .C(_0217_),
    .D(_0608_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0625_));
 sky130_fd_sc_hd__nor2_2 _1294_ (.A(_0624_),
    .B(_0625_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0063_));
 sky130_fd_sc_hd__xnor2_2 _1295_ (.A(_0131_),
    .B(_0625_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0064_));
 sky130_fd_sc_hd__a21oi_2 _1296_ (.A1(net150),
    .A2(_0625_),
    .B1(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0626_));
 sky130_fd_sc_hd__and4_2 _1297_ (.A(\game.pixel_y[8] ),
    .B(\game.pixel_y[7] ),
    .C(\game.pixel_y[6] ),
    .D(_0623_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0627_));
 sky130_fd_sc_hd__nor2_2 _1298_ (.A(_0626_),
    .B(_0627_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0065_));
 sky130_fd_sc_hd__or3b_2 _1299_ (.A(_0134_),
    .B(_0161_),
    .C_N(_0625_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0628_));
 sky130_fd_sc_hd__o211a_2 _1300_ (.A1(\game.pixel_y[9] ),
    .A2(_0627_),
    .B1(_0628_),
    .C1(_0613_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0066_));
 sky130_fd_sc_hd__and2b_2 _1301_ (.A_N(\gamepad.driver.pmod_latch_prev ),
    ...
    .VPWR(VPWR),
    .X(_0629_));
 sky130_fd_sc_hd__nand2b_2 _1302_ (.A_N(\gamepad.driver.pmod_latch_prev ),
    .B(\gamepad.driver.pmod_latch_sync[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0630_));
 sky130_fd_sc_hd__a21bo_2 _1303_ (.A1(\gamepad.driver.shift_reg[0] ),
    .A2(net20),
    .B1_N(net60),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0631_));
 sky130_fd_sc_hd__a21o_2 _1304_ (.A1(net88),
    .A2(net19),
    .B1(_0631_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0067_));
 sky130_fd_sc_hd__a21bo_2 _1305_ (.A1(\gamepad.driver.shift_reg[1] ),
    .A2(net20),
    .B1_N(net59),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0632_));
 sky130_fd_sc_hd__a21o_2 _1306_ (.A1(net90),
    .A2(net19),
    .B1(_0632_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0068_));
 sky130_fd_sc_hd__a21bo_2 _1307_ (.A1(\gamepad.driver.shift_reg[2] ),
    .A2(net20),
    .B1_N(net59),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0633_));
 sky130_fd_sc_hd__a21o_2 _1308_ (.A1(net82),
    .A2(net19),
    .B1(_0633_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0069_));
 sky130_fd_sc_hd__a21bo_2 _1309_ (.A1(net103),
    .A2(_0629_),
    .B1_N(net59),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0634_));
 sky130_fd_sc_hd__a21o_2 _1310_ (.A1(net124),
    .A2(_0630_),
    .B1(_0634_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0070_));
 sky130_fd_sc_hd__a21bo_2 _1311_ (.A1(net122),
    .A2(net20),
    .B1_N(net58),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0635_));
 sky130_fd_sc_hd__a21o_2 _1312_ (.A1(net123),
    .A2(net19),
    .B1(_0635_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0071_));
 sky130_fd_sc_hd__a21bo_2 _1313_ (.A1(\gamepad.driver.shift_reg[5] ),
    .A2(net20),
    .B1_N(net58),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0636_));
 sky130_fd_sc_hd__a21o_2 _1314_ (.A1(net117),
    .A2(net19),
    .B1(_0636_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0072_));
 sky130_fd_sc_hd__a21bo_2 _1315_ (.A1(\gamepad.driver.shift_reg[6] ),
    .A2(net20),
    .B1_N(net58),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0637_));
 sky130_fd_sc_hd__a21o_2 _1316_ (.A1(net86),
    .A2(net19),
    .B1(_0637_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0073_));
 sky130_fd_sc_hd__a21bo_2 _1317_ (.A1(\gamepad.driver.shift_reg[7] ),
    .A2(net20),
    .B1_N(net58),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0638_));
 sky130_fd_sc_hd__a21o_2 _1318_ (.A1(net80),
    .A2(net19),
    .B1(_0638_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0074_));
 sky130_fd_sc_hd__a21bo_2 _1319_ (.A1(\gamepad.driver.shift_reg[8] ),
    .A2(net20),
    .B1_N(net58),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0639_));
 sky130_fd_sc_hd__a21o_2 _1320_ (.A1(net84),
    .A2(net19),
    .B1(_0639_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0075_));
 sky130_fd_sc_hd__a21bo_2 _1321_ (.A1(\gamepad.driver.shift_reg[9] ),
    .A2(net20),
    .B1_N(net58),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0640_));
 sky130_fd_sc_hd__a21o_2 _1322_ (.A1(net92),
    .A2(net19),
    .B1(_0640_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0076_));
 sky130_fd_sc_hd__a21bo_2 _1323_ (.A1(\gamepad.driver.shift_reg[10] ),
    .A2(net20),
    .B1_N(net58),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0641_));
 sky130_fd_sc_hd__a21o_2 _1324_ (.A1(net78),
    .A2(net19),
    .B1(_0641_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0077_));
 sky130_fd_sc_hd__a21bo_2 _1325_ (.A1(net94),
    .A2(_0629_),
    .B1_N(net60),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0642_));
 sky130_fd_sc_hd__a21o_2 _1326_ (.A1(net115),
    .A2(_0630_),
    .B1(_0642_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0078_));
 sky130_fd_sc_hd__and2_2 _1327_ (.A(net127),
    .B(net59),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0079_));
 sky130_fd_sc_hd__and2_2 _1328_ (.A(net129),
    .B(net60),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0080_));
 sky130_fd_sc_hd__and2b_2 _1329_ (.A_N(\gamepad.driver.pmod_clk_prev ),
    ...
    .VPWR(VPWR),
    .X(_0643_));
 sky130_fd_sc_hd__nand2b_2 _1330_ (.A_N(\gamepad.driver.pmod_clk_prev ),
    .B(\gamepad.driver.pmod_clk_sync[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0644_));
 sky130_fd_sc_hd__a21bo_2 _1331_ (.A1(\gamepad.driver.pmod_data_sync[1] ),
    .A2(net18),
    .B1_N(net59),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0645_));
 sky130_fd_sc_hd__a21o_2 _1332_ (.A1(net109),
    .A2(net17),
    .B1(_0645_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0081_));
 sky130_fd_sc_hd__a21bo_2 _1333_ (.A1(\gamepad.driver.shift_reg[0] ),
    .A2(net18),
    .B1_N(net59),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0646_));
 sky130_fd_sc_hd__a21o_2 _1334_ (.A1(net107),
    .A2(net17),
    .B1(_0646_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0082_));
 sky130_fd_sc_hd__a21bo_2 _1335_ (.A1(net107),
    .A2(net18),
    .B1_N(net60),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0647_));
 sky130_fd_sc_hd__a21o_2 _1336_ (.A1(net113),
    .A2(_0644_),
    .B1(_0647_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0083_));
 sky130_fd_sc_hd__a21bo_2 _1337_ (.A1(\gamepad.driver.shift_reg[2] ),
    .A2(_0643_),
    .B1_N(net59),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0648_));
 sky130_fd_sc_hd__a21o_2 _1338_ (.A1(net103),
    .A2(_0644_),
    .B1(_0648_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0084_));
 sky130_fd_sc_hd__a21bo_2 _1339_ (.A1(net103),
    .A2(_0643_),
    .B1_N(net59),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0649_));
 sky130_fd_sc_hd__a21o_2 _1340_ (.A1(net122),
    .A2(net17),
    .B1(_0649_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0085_));
 sky130_fd_sc_hd__a21bo_2 _1341_ (.A1(\gamepad.driver.shift_reg[4] ),
    .A2(net18),
    .B1_N(net58),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0650_));
 sky130_fd_sc_hd__a21o_2 _1342_ (.A1(net119),
    .A2(net17),
    .B1(_0650_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0086_));
 sky130_fd_sc_hd__a21bo_2 _1343_ (.A1(\gamepad.driver.shift_reg[5] ),
    .A2(net18),
    .B1_N(net58),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0651_));
 sky130_fd_sc_hd__a21o_2 _1344_ (.A1(net111),
    .A2(net17),
    .B1(_0651_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0087_));
 sky130_fd_sc_hd__a21bo_2 _1345_ (.A1(net111),
    .A2(net18),
    .B1_N(net61),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0652_));
 sky130_fd_sc_hd__a21o_2 _1346_ (.A1(net121),
    .A2(net17),
    .B1(_0652_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0088_));
 sky130_fd_sc_hd__a21bo_2 _1347_ (.A1(\gamepad.driver.shift_reg[7] ),
    .A2(net18),
    .B1_N(net61),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0653_));
 sky130_fd_sc_hd__a21o_2 _1348_ (.A1(net105),
    .A2(net17),
    .B1(_0653_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0089_));
 sky130_fd_sc_hd__a21bo_2 _1349_ (.A1(\gamepad.driver.shift_reg[8] ),
    .A2(net18),
    .B1_N(net61),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0654_));
 sky130_fd_sc_hd__a21o_2 _1350_ (.A1(net101),
    .A2(net17),
    .B1(_0654_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0090_));
 sky130_fd_sc_hd__dfrtp_2 _1351_ (.CLK(clknet_4_8_0_clk),
    .D(_0011_),
    .RESET_B(net53),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.player_x[0] ));
 sky130_fd_sc_hd__dfrtp_2 _1352_ (.CLK(clknet_4_8_0_clk),
    .D(_0012_),
    .RESET_B(net53),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.player_x[1] ));
 sky130_fd_sc_hd__dfstp_2 _1353_ (.CLK(clknet_4_8_0_clk),
    .D(_0013_),
    .SET_B(net52),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.player_x[2] ));
 sky130_fd_sc_hd__dfstp_2 _1354_ (.CLK(clknet_4_8_0_clk),
    .D(_0014_),
    .SET_B(net52),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.player_x[3] ));
 sky130_fd_sc_hd__dfrtp_2 _1355_ (.CLK(clknet_4_8_0_clk),
    .D(_0015_),
    .RESET_B(net52),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.player_x[4] ));
 sky130_fd_sc_hd__dfstp_2 _1356_ (.CLK(clknet_4_10_0_clk),
    .D(_0016_),
    .SET_B(net53),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.player_x[5] ));
 sky130_fd_sc_hd__dfrtp_2 _1357_ (.CLK(clknet_4_8_0_clk),
    .D(_0017_),
    .RESET_B(net52),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _1358_ (.CLK(clknet_4_10_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\game.player_x[7] ));
 sky130_fd_sc_hd__dfstp_2 _1359_ (.CLK(clknet_4_10_0_clk),
    .D(_0019_),
    .SET_B(net54),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.player_x[8] ));
 sky130_fd_sc_hd__dfrtp_2 _1360_ (.CLK(clknet_4_10_0_clk),
    .D(_0020_),
    .RESET_B(net54),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _1361_ (.CLK(clknet_4_10_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\game.player_x[10] ));
 sky130_fd_sc_hd__dfrtp_2 _1362_ (.CLK(clknet_4_3_0_clk),
    .D(_0022_),
    .RESET_B(net45),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.alien_x[0] ));
 sky130_fd_sc_hd__dfstp_2 _1363_ (.CLK(clknet_4_2_0_clk),
    .D(_0023_),
    .SET_B(net45),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.alien_x[1] ));
 sky130_fd_sc_hd__dfrtp_2 _1364_ (.CLK(clknet_4_2_0_clk),
    .D(_0024_),
    .RESET_B(net45),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.alien_x[2] ));
 sky130_fd_sc_hd__dfstp_2 _1365_ (.CLK(clknet_4_0_0_clk),
    .D(_0025_),
    .SET_B(net42),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.alien_x[3] ));
 sky130_fd_sc_hd__dfrtp_2 _1366_ (.CLK(clknet_4_0_0_clk),
    .D(_0026_),
    .RESET_B(net42),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _1367_ (.CLK(clknet_4_0_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\game.alien_x[5] ));
 sky130_fd_sc_hd__dfrtp_2 _1368_ (.CLK(clknet_4_0_0_clk),
    .D(_0028_),
    .RESET_B(net43),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.alien_x[6] ));
 sky130_fd_sc_hd__dfrtp_2 _1369_ (.CLK(clknet_4_0_0_clk),
    .D(_0029_),
    .RESET_B(net43),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.alien_x[7] ));
 sky130_fd_sc_hd__dfrtp_2 _1370_ (.CLK(clknet_4_2_0_clk),
    .D(_0030_),
    .RESET_B(net45),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _1371_ (.CLK(clknet_4_2_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\game.alien_x[9] ));
 sky130_fd_sc_hd__dfrtp_2 _1372_ (.CLK(clknet_4_2_0_clk),
    .D(_0032_),
    .RESET_B(net42),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.alien_x[10] ));
 sky130_fd_sc_hd__dfrtp_2 _1373_ (.CLK(clknet_4_0_0_clk),
    .D(_0033_),
    .RESET_B(net43),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.alien_dir ));
 sky130_fd_sc_hd__dfstp_2 _1374_ (.CLK(clknet_4_1_0_clk),
    .D(_0034_),
    .SET_B(net43),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\game.aliens_alive[0] ));
 sky130_fd_sc_hd__dfstp_2 _1375_ (.CLK(clknet_4_1_0_clk),
    .D(_0035_),
    .SET_B(net43),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\game.aliens_alive[1] ));
 sky130_fd_sc_hd__dfstp_2 _1376_ (.CLK(clknet_4_0_0_clk),
    .D(_0036_),
    .SET_B(net44),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\game.aliens_alive[2] ));
 sky130_fd_sc_hd__dfstp_2 _1377_ (.CLK(clknet_4_3_0_clk),
    .D(_0037_),
    .SET_B(net44),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\game.aliens_alive[3] ));
 sky130_fd_sc_hd__dfstp_2 _1378_ (.CLK(clknet_4_1_0_clk),
    .D(_0038_),
    .SET_B(net44),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\game.aliens_alive[4] ));
 sky130_fd_sc_hd__dfstp_2 _1379_ (.CLK(clknet_4_0_0_clk),
    .D(_0039_),
    .SET_B(net44),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\game.aliens_alive[5] ));
 sky130_fd_sc_hd__dfstp_2 _1380_ (.CLK(clknet_4_1_0_clk),
    .D(_0040_),
    .SET_B(net44),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\game.aliens_alive[6] ));
 sky130_fd_sc_hd__dfstp_2 _1381_ (.CLK(clknet_4_1_0_clk),
    .D(_0041_),
    .SET_B(net47),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\game.aliens_alive[7] ));
 sky130_fd_sc_hd__dfrtp_2 _1382_ (.CLK(clknet_4_9_0_clk),
    .D(_0042_),
    .RESET_B(net51),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.proj_x[0] ));
 sky130_fd_sc_hd__dfrtp_2 _1383_ (.CLK(clknet_4_8_0_clk),
    .D(_0043_),
    .RESET_B(net53),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.proj_x[1] ));
 sky130_fd_sc_hd__dfrtp_2 _1384_ (.CLK(clknet_4_2_0_clk),
    .D(_0044_),
    .RESET_B(net51),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.proj_x[2] ));
 sky130_fd_sc_hd__dfrtp_2 _1385_ (.CLK(clknet_4_8_0_clk),
    .D(_0045_),
    .RESET_B(net53),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.proj_x[3] ));
 sky130_fd_sc_hd__dfrtp_2 _1386_ (.CLK(clknet_4_9_0_clk),
    .D(_0046_),
    .RESET_B(net51),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.proj_x[4] ));
 sky130_fd_sc_hd__dfrtp_2 _1387_ (.CLK(clknet_4_2_0_clk),
    .D(_0047_),
    .RESET_B(net51),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.proj_x[5] ));
 sky130_fd_sc_hd__dfrtp_2 _1388_ (.CLK(clknet_4_3_0_clk),
    .D(_0048_),
    .RESET_B(net45),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.proj_x[6] ));
 sky130_fd_sc_hd__dfrtp_2 _1389_ (.CLK(clknet_4_3_0_clk),
    .D(_0049_),
    .RESET_B(net50),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.proj_x[7] ));
 sky130_fd_sc_hd__dfrtp_2 _1390_ (.CLK(clknet_4_3_0_clk),
    .D(_0050_),
    .RESET_B(net45),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.proj_x[8] ));
 sky130_fd_sc_hd__dfrtp_2 _1391_ (.CLK(clknet_4_3_0_clk),
    .D(_0051_),
    .RESET_B(net54),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.proj_x[9] ));
 sky130_fd_sc_hd__dfrtp_2 _1392_ (.CLK(clknet_4_6_0_clk),
    .D(_0052_),
    .RESET_B(net49),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.proj_x[10] ));
 sky130_fd_sc_hd__dfrtp_2 _1393_ (.CLK(clknet_4_3_0_clk),
    .D(_0053_),
    .RESET_B(net46),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.proj_active ));
 sky130_fd_sc_hd__dfrtp_2 _1394_ (.CLK(clknet_4_1_0_clk),
    .D(_0054_),
    .RESET_B(net47),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.wait_cnt[0] ));
 sky130_fd_sc_hd__dfrtp_2 _1395_ (.CLK(clknet_4_4_0_clk),
    .D(_0055_),
    .RESET_B(net47),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.wait_cnt[1] ));
 sky130_fd_sc_hd__dfrtp_2 _1396_ (.CLK(clknet_4_1_0_clk),
    .D(_0056_),
    .RESET_B(net47),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.wait_cnt[2] ));
 sky130_fd_sc_hd__dfrtp_2 _1397_ (.CLK(clknet_4_7_0_clk),
    .D(_0057_),
    .RESET_B(net57),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.pixel_y[0] ));
 sky130_fd_sc_hd__dfrtp_2 _1398_ (.CLK(clknet_4_13_0_clk),
    .D(_0058_),
    .RESET_B(net57),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.pixel_y[1] ));
 sky130_fd_sc_hd__dfrtp_2 _1399_ (.CLK(clknet_4_13_0_clk),
    .D(_0059_),
    .RESET_B(net57),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.pixel_y[2] ));
 sky130_fd_sc_hd__dfrtp_2 _1400_ (.CLK(clknet_4_13_0_clk),
    .D(_0060_),
    .RESET_B(net57),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.pixel_y[3] ));
 sky130_fd_sc_hd__dfrtp_2 _1401_ (.CLK(clknet_4_13_0_clk),
    .D(_0061_),
    .RESET_B(net57),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.pixel_y[4] ));
 sky130_fd_sc_hd__dfrtp_2 _1402_ (.CLK(clknet_4_13_0_clk),
    .D(_0062_),
    .RESET_B(net57),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.pixel_y[5] ));
 sky130_fd_sc_hd__dfrtp_2 _1403_ (.CLK(clknet_4_7_0_clk),
    .D(_0063_),
    .RESET_B(net57),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.pixel_y[6] ));
 sky130_fd_sc_hd__dfrtp_2 _1404_ (.CLK(clknet_4_7_0_clk),
    .D(_0064_),
    .RESET_B(net49),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.pixel_y[7] ));
 sky130_fd_sc_hd__dfrtp_2 _1405_ (.CLK(clknet_4_7_0_clk),
    .D(_0065_),
    .RESET_B(net56),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.pixel_y[8] ));
 sky130_fd_sc_hd__dfrtp_2 _1406_ (.CLK(clknet_4_7_0_clk),
    .D(_0066_),
    .RESET_B(net56),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.pixel_y[9] ));
 sky130_fd_sc_hd__dfxtp_2 _1407_ (.CLK(clknet_4_13_0_clk),
    .D(net89),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1408_ (.CLK(clknet_4_12_0_clk),
    .D(net91),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1409_ (.CLK(clknet_4_12_0_clk),
    .D(net83),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1410_ (.CLK(clknet_4_15_0_clk),
    .D(net125),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1413_ (.CLK(clknet_4_6_0_clk),
    .D(net87),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1416_ (.CLK(clknet_4_11_0_clk),
    .D(net93),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1419_ (.CLK(clknet_4_15_0_clk),
    .D(_0079_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1420_ (.CLK(clknet_4_12_0_clk),
    .D(_0080_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1421_ (.CLK(clknet_4_15_0_clk),
    .D(net110),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1422_ (.CLK(clknet_4_15_0_clk),
    .D(net108),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1423_ (.CLK(clknet_4_14_0_clk),
    .D(net114),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1425_ (.CLK(clknet_4_14_0_clk),
    .D(_0085_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1426_ (.CLK(clknet_4_10_0_clk),
    .D(net120),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1427_ (.CLK(clknet_4_10_0_clk),
    .D(net112),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1428_ (.CLK(clknet_4_14_0_clk),
    .D(_0088_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1429_ (.CLK(clknet_4_14_0_clk),
    .D(net106),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1430_ (.CLK(clknet_4_14_0_clk),
    .D(net102),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1431_ (.CLK(clknet_4_14_0_clk),
    .D(net100),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1432_ (.CLK(clknet_4_12_0_clk),
    .D(net95),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1433_ (.CLK(clknet_4_12_0_clk),
    .D(_0093_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1434_ (.CLK(clknet_4_15_0_clk),
    .D(_0094_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1436_ (.CLK(clknet_4_12_0_clk),
    .D(_0096_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1437_ (.CLK(clknet_4_12_0_clk),
    .D(_0097_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1438_ (.CLK(clknet_4_13_0_clk),
    .D(_0098_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfrtp_2 _1439_ (.CLK(clknet_4_9_0_clk),
    .D(_0000_),
    .RESET_B(net51),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.pixel_x[0] ));
 sky130_fd_sc_hd__dfrtp_2 _1440_ (.CLK(clknet_4_9_0_clk),
    .D(_0002_),
    .RESET_B(net51),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.pixel_x[1] ));
 sky130_fd_sc_hd__dfrtp_2 _1441_ (.CLK(clknet_4_9_0_clk),
    .D(_0003_),
    .RESET_B(net51),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.pixel_x[2] ));
 sky130_fd_sc_hd__dfrtp_2 _1442_ (.CLK(clknet_4_9_0_clk),
    .D(_0004_),
    .RESET_B(net51),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.pixel_x[3] ));
 sky130_fd_sc_hd__dfrtp_2 _1443_ (.CLK(clknet_4_9_0_clk),
    .D(_0005_),
    .RESET_B(net51),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.pixel_x[4] ));
 sky130_fd_sc_hd__dfrtp_2 _1444_ (.CLK(clknet_4_6_0_clk),
    .D(_0006_),
    .RESET_B(net56),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.pixel_x[5] ));
 sky130_fd_sc_hd__dfrtp_2 _1445_ (.CLK(clknet_4_6_0_clk),
    .D(_0007_),
    .RESET_B(net56),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.pixel_x[6] ));
 sky130_fd_sc_hd__dfrtp_2 _1446_ (.CLK(clknet_4_6_0_clk),
    .D(_0008_),
    .RESET_B(net56),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.pixel_x[7] ));
 sky130_fd_sc_hd__dfrtp_2 _1447_ (.CLK(clknet_4_6_0_clk),
    .D(_0009_),
    .RESET_B(net56),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.pixel_x[8] ));
 sky130_fd_sc_hd__dfrtp_2 _1448_ (.CLK(clknet_4_6_0_clk),
    .D(_0010_),
    .RESET_B(net56),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.pixel_x[9] ));
 sky130_fd_sc_hd__dfrtp_2 _1449_ (.CLK(clknet_4_11_0_clk),
    .D(_0001_),
    .RESET_B(net56),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _1450_ (.CLK(clknet_4_7_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\game.vsync_d ));
 sky130_fd_sc_hd__dfrtp_2 _1451_ (.CLK(clknet_4_4_0_clk),
    .D(_0099_),
    .RESET_B(net47),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.alien_y[5] ));
 sky130_fd_sc_hd__dfrtp_2 _1452_ (.CLK(clknet_4_4_0_clk),
    .D(_0100_),
    .RESET_B(net47),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.alien_y[6] ));
 sky130_fd_sc_hd__dfrtp_2 _1453_ (.CLK(clknet_4_4_0_clk),
    .D(_0101_),
    .RESET_B(net47),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.alien_y[7] ));
 sky130_fd_sc_hd__dfrtp_2 _1454_ (.CLK(clknet_4_4_0_clk),
    .D(_0102_),
    .RESET_B(net47),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.alien_y[8] ));
 sky130_fd_sc_hd__dfrtp_2 _1455_ (.CLK(clknet_4_4_0_clk),
    .D(_0103_),
    .RESET_B(net47),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.alien_y[9] ));
 sky130_fd_sc_hd__dfrtp_2 _1456_ (.CLK(clknet_4_4_0_clk),
    .D(_0104_),
    .RESET_B(net48),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.proj_y[3] ));
 sky130_fd_sc_hd__dfrtp_2 _1457_ (.CLK(clknet_4_4_0_clk),
    .D(_0105_),
    .RESET_B(net48),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.proj_y[4] ));
 sky130_fd_sc_hd__dfrtp_2 _1458_ (.CLK(clknet_4_5_0_clk),
    .D(_0106_),
    .RESET_B(net48),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.proj_y[5] ));
 sky130_fd_sc_hd__dfrtp_2 _1459_ (.CLK(clknet_4_5_0_clk),
    .D(_0107_),
    .RESET_B(net48),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.proj_y[6] ));
 sky130_fd_sc_hd__dfrtp_2 _1460_ (.CLK(clknet_4_5_0_clk),
    .D(_0108_),
    .RESET_B(net48),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.proj_y[7] ));
 sky130_fd_sc_hd__dfrtp_2 _1461_ (.CLK(clknet_4_5_0_clk),
    .D(_0109_),
    .RESET_B(net48),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.proj_y[8] ));
 sky130_fd_sc_hd__dfrtp_2 _1462_ (.CLK(clknet_4_5_0_clk),
    .D(_0110_),
    .RESET_B(net48),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.proj_y[9] ));
 sky130_fd_sc_hd__dfrtp_2 _1463_ (.CLK(clknet_4_5_0_clk),
    .D(_0111_),
    .RESET_B(net49),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.proj_y[0] ));
 sky130_fd_sc_hd__dfrtp_2 _1464_ (.CLK(clknet_4_7_0_clk),
    .D(_0112_),
    .RESET_B(net49),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.proj_y[1] ));
 sky130_fd_sc_hd__dfrtp_2 _1465_ (.CLK(clknet_4_5_0_clk),
    .D(_0113_),
    .RESET_B(net49),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game.proj_y[2] ));
 sky130_fd_sc_hd__buf_2 _1482_ (.A(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[0]));
 sky130_fd_sc_hd__buf_2 _1483_ (.A(net5),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[1]));
 sky130_fd_sc_hd__buf_2 _1484_ (.A(uo_out[6]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[2]));
 sky130_fd_sc_hd__buf_2 _1485_ (.A(\game.vga_inst.vsync ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[3]));
 sky130_fd_sc_hd__buf_2 _1486_ (.A(\game.hsync ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 clkload9 (.A(clknet_4_10_0_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout10 (.A(_0583_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net10));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout15 (.A(_0393_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net15));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout16 (.A(_0393_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net16));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout17 (.A(_0644_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net17));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout18 (.A(_0643_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net18));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout19 (.A(_0630_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net19));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout20 (.A(_0629_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net20));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout21 (.A(\game.alien_y[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net21));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout22 (.A(\game.pixel_x[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net22));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout23 (.A(\game.pixel_x[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net23));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout24 (.A(\game.pixel_x[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net24));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout25 (.A(\game.pixel_x[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net25));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout26 (.A(\game.pixel_x[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net26));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout27 (.A(\game.pixel_x[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net27));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout28 (.A(\game.pixel_y[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net28));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout29 (.A(\game.pixel_y[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net29));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout30 (.A(\game.pixel_y[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net30));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout31 (.A(\game.pixel_y[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net31));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout32 (.A(\game.alien_dir ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net32));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout33 (.A(\game.alien_dir ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net33));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout34 (.A(\game.alien_x[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net34));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout35 (.A(\game.alien_x[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net35));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout36 (.A(\game.alien_x[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net36));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout37 (.A(\game.player_x[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net37));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout38 (.A(\game.player_x[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net38));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout39 (.A(\game.player_x[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net39));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout40 (.A(\game.player_x[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net40));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout41 (.A(\game.player_x[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout44 (.A(net45),
    ...
    .VPWR(VPWR),
    .X(net44));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout45 (.A(net62),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout48 (.A(net49),
    ...
    .VPWR(VPWR),
    .X(net48));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout49 (.A(net62),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout52 (.A(net54),
    ...
    .VPWR(VPWR),
    .X(net52));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout54 (.A(net62),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net54));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout55 (.A(net62),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout62 (.A(net1),
    ...
    .VPWR(VPWR),
    .X(net62));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout7 (.A(_0454_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold100 (.A(_0091_),
    ...
    .VPWR(VPWR),
    .X(net100));
 sky130_fd_sc_hd__dlygate4sd3_1 hold101 (.A(\gamepad.driver.shift_reg[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold102 (.A(_0090_),
    ...
    .VPWR(VPWR),
    .X(net102));
 sky130_fd_sc_hd__dlygate4sd3_1 hold103 (.A(\gamepad.driver.shift_reg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net103));
 sky130_fd_sc_hd__dlygate4sd3_1 hold104 (.A(_0084_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net104));
 sky130_fd_sc_hd__dlygate4sd3_1 hold105 (.A(\gamepad.driver.shift_reg[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net105));
 sky130_fd_sc_hd__dlygate4sd3_1 hold106 (.A(_0089_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net106));
 sky130_fd_sc_hd__dlygate4sd3_1 hold107 (.A(\gamepad.driver.shift_reg[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold108 (.A(_0082_),
    ...
    .VPWR(VPWR),
    .X(net108));
 sky130_fd_sc_hd__dlygate4sd3_1 hold109 (.A(\gamepad.driver.shift_reg[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net109));
 sky130_fd_sc_hd__dlygate4sd3_1 hold110 (.A(_0081_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net110));
 sky130_fd_sc_hd__dlygate4sd3_1 hold111 (.A(\gamepad.driver.shift_reg[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net111));
 sky130_fd_sc_hd__dlygate4sd3_1 hold112 (.A(_0087_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net112));
 sky130_fd_sc_hd__dlygate4sd3_1 hold113 (.A(\gamepad.driver.shift_reg[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net113));
 sky130_fd_sc_hd__dlygate4sd3_1 hold114 (.A(_0083_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net114));
 sky130_fd_sc_hd__dlygate4sd3_1 hold115 (.A(\gamepad.decoder.data_reg[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net115));
 sky130_fd_sc_hd__dlygate4sd3_1 hold116 (.A(_0078_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net116));
 sky130_fd_sc_hd__dlygate4sd3_1 hold117 (.A(\gamepad.decoder.data_reg[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net117));
 sky130_fd_sc_hd__dlygate4sd3_1 hold118 (.A(_0072_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net118));
 sky130_fd_sc_hd__dlygate4sd3_1 hold119 (.A(\gamepad.driver.shift_reg[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net119));
 sky130_fd_sc_hd__dlygate4sd3_1 hold120 (.A(_0086_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net120));
 sky130_fd_sc_hd__dlygate4sd3_1 hold121 (.A(\gamepad.driver.shift_reg[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net121));
 sky130_fd_sc_hd__dlygate4sd3_1 hold122 (.A(\gamepad.driver.shift_reg[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net122));
 sky130_fd_sc_hd__dlygate4sd3_1 hold123 (.A(\gamepad.decoder.data_reg[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net123));
 sky130_fd_sc_hd__dlygate4sd3_1 hold124 (.A(\gamepad.decoder.data_reg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net124));
 sky130_fd_sc_hd__dlygate4sd3_1 hold125 (.A(_0070_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net125));
 sky130_fd_sc_hd__dlygate4sd3_1 hold126 (.A(\game.aliens_alive[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net126));
 sky130_fd_sc_hd__dlygate4sd3_1 hold127 (.A(\gamepad.driver.pmod_clk_sync[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net127));
 sky130_fd_sc_hd__dlygate4sd3_1 hold128 (.A(\game.aliens_alive[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net128));
 sky130_fd_sc_hd__dlygate4sd3_1 hold129 (.A(\gamepad.driver.pmod_latch_sync[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net129));
 sky130_fd_sc_hd__dlygate4sd3_1 hold130 (.A(\game.aliens_alive[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net130));
 sky130_fd_sc_hd__dlygate4sd3_1 hold131 (.A(\game.aliens_alive[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net131));
 sky130_fd_sc_hd__dlygate4sd3_1 hold132 (.A(\game.aliens_alive[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net132));
 sky130_fd_sc_hd__dlygate4sd3_1 hold133 (.A(\game.aliens_alive[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net133));
 sky130_fd_sc_hd__dlygate4sd3_1 hold134 (.A(\game.aliens_alive[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net134));
 sky130_fd_sc_hd__dlygate4sd3_1 hold135 (.A(\game.wait_cnt[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net135));
 sky130_fd_sc_hd__dlygate4sd3_1 hold136 (.A(\game.aliens_alive[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net136));
 sky130_fd_sc_hd__dlygate4sd3_1 hold137 (.A(\game.wait_cnt[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net137));
 sky130_fd_sc_hd__dlygate4sd3_1 hold138 (.A(\game.player_x[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net138));
 sky130_fd_sc_hd__dlygate4sd3_1 hold139 (.A(\game.wait_cnt[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net139));
 sky130_fd_sc_hd__dlygate4sd3_1 hold140 (.A(\game.proj_y[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net140));
 sky130_fd_sc_hd__dlygate4sd3_1 hold141 (.A(\game.proj_y[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net141));
 sky130_fd_sc_hd__dlygate4sd3_1 hold142 (.A(\game.proj_x[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net142));
 sky130_fd_sc_hd__dlygate4sd3_1 hold143 (.A(\game.pixel_x[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net143));
 sky130_fd_sc_hd__dlygate4sd3_1 hold144 (.A(\game.player_x[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net144));
 sky130_fd_sc_hd__dlygate4sd3_1 hold145 (.A(\game.alien_dir ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net145));
 sky130_fd_sc_hd__dlygate4sd3_1 hold146 (.A(\game.pixel_y[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net146));
 sky130_fd_sc_hd__dlygate4sd3_1 hold147 (.A(\game.pixel_y[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net147));
 sky130_fd_sc_hd__dlygate4sd3_1 hold148 (.A(\game.player_x[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net148));
 sky130_fd_sc_hd__dlygate4sd3_1 hold149 (.A(\game.alien_y[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net149));
 sky130_fd_sc_hd__dlygate4sd3_1 hold150 (.A(\game.pixel_y[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net150));
 sky130_fd_sc_hd__dlygate4sd3_1 hold151 (.A(\game.proj_x[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net151));
 sky130_fd_sc_hd__dlygate4sd3_1 hold152 (.A(\game.proj_y[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net152));
 sky130_fd_sc_hd__dlygate4sd3_1 hold153 (.A(\game.alien_x[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net153));
 sky130_fd_sc_hd__dlygate4sd3_1 hold154 (.A(\game.wait_cnt[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net154));
 sky130_fd_sc_hd__dlygate4sd3_1 hold155 (.A(\game.pixel_x[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net155));
 sky130_fd_sc_hd__dlygate4sd3_1 hold78 (.A(\gamepad.decoder.data_reg[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold79 (.A(_0077_),
    ...
    .VPWR(VPWR),
    .X(net79));
 sky130_fd_sc_hd__dlygate4sd3_1 hold80 (.A(\gamepad.decoder.data_reg[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net80));
 sky130_fd_sc_hd__dlygate4sd3_1 hold81 (.A(_0074_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net81));
 sky130_fd_sc_hd__dlygate4sd3_1 hold82 (.A(\gamepad.decoder.data_reg[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net82));
 sky130_fd_sc_hd__dlygate4sd3_1 hold83 (.A(_0069_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net83));
 sky130_fd_sc_hd__dlygate4sd3_1 hold84 (.A(\gamepad.decoder.data_reg[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net84));
 sky130_fd_sc_hd__dlygate4sd3_1 hold85 (.A(_0075_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net85));
 sky130_fd_sc_hd__dlygate4sd3_1 hold86 (.A(\gamepad.decoder.data_reg[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net86));
 sky130_fd_sc_hd__dlygate4sd3_1 hold87 (.A(_0073_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net87));
 sky130_fd_sc_hd__dlygate4sd3_1 hold88 (.A(\gamepad.decoder.data_reg[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net88));
 sky130_fd_sc_hd__dlygate4sd3_1 hold89 (.A(_0067_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net89));
 sky130_fd_sc_hd__dlygate4sd3_1 hold90 (.A(\gamepad.decoder.data_reg[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net90));
 sky130_fd_sc_hd__dlygate4sd3_1 hold91 (.A(_0068_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net91));
 sky130_fd_sc_hd__dlygate4sd3_1 hold92 (.A(\gamepad.decoder.data_reg[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net92));
 sky130_fd_sc_hd__dlygate4sd3_1 hold93 (.A(_0076_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net93));
 sky130_fd_sc_hd__dlygate4sd3_1 hold94 (.A(\gamepad.driver.shift_reg[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net94));
 sky130_fd_sc_hd__dlygate4sd3_1 hold95 (.A(_0092_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net95));
 sky130_fd_sc_hd__dlygate4sd3_1 hold96 (.A(\gamepad.driver.pmod_clk_sync[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net96));
 sky130_fd_sc_hd__dlygate4sd3_1 hold97 (.A(\gamepad.driver.pmod_latch_sync[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net97));
 sky130_fd_sc_hd__dlygate4sd3_1 hold98 (.A(\gamepad.driver.pmod_data_sync[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net98));
 sky130_fd_sc_hd__dlygate4sd3_1 hold99 (.A(\gamepad.driver.shift_reg[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 load_slew53 (.A(net52),
    ...
    .VPWR(VPWR),
    .X(net53));
 sky130_fd_sc_hd__buf_4 load_slew9 (.A(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__buf_1 max_cap12 (.A(_0444_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 max_cap13 (.A(net14),
    ...
    .VPWR(VPWR),
    .X(net13));
 sky130_fd_sc_hd__conb_1 tt_um_shiho_space_invaders (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_shiho_space_invaders_63 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net63));
 sky130_fd_sc_hd__conb_1 tt_um_shiho_space_invaders_64 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net64));
 sky130_fd_sc_hd__conb_1 tt_um_shiho_space_invaders_65 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net65));
 sky130_fd_sc_hd__conb_1 tt_um_shiho_space_invaders_66 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net66));
 sky130_fd_sc_hd__conb_1 tt_um_shiho_space_invaders_67 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net67));
 sky130_fd_sc_hd__conb_1 tt_um_shiho_space_invaders_68 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net68));
 sky130_fd_sc_hd__conb_1 tt_um_shiho_space_invaders_69 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net69));
 sky130_fd_sc_hd__conb_1 tt_um_shiho_space_invaders_70 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net70));
 sky130_fd_sc_hd__conb_1 tt_um_shiho_space_invaders_71 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net71));
 sky130_fd_sc_hd__conb_1 tt_um_shiho_space_invaders_72 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net72));
 sky130_fd_sc_hd__conb_1 tt_um_shiho_space_invaders_73 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net73));
 sky130_fd_sc_hd__conb_1 tt_um_shiho_space_invaders_74 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net74));
 sky130_fd_sc_hd__conb_1 tt_um_shiho_space_invaders_75 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net75));
 sky130_fd_sc_hd__conb_1 tt_um_shiho_space_invaders_76 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net76));
 sky130_fd_sc_hd__conb_1 tt_um_shiho_space_invaders_77 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net77));
 sky130_fd_sc_hd__buf_2 wire14 (.A(_0398_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
