module tt_um_sanity_bouncing_box (clk,
    ena,
    rst_n,
    VPWR,
    VGND,
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_137 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _276_ (.A(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_262_));
 sky130_fd_sc_hd__inv_2 _277_ (.A(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_263_));
 sky130_fd_sc_hd__inv_2 _278_ (.A(\box_x[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_264_));
 sky130_fd_sc_hd__inv_2 _279_ (.A(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_265_));
 sky130_fd_sc_hd__inv_2 _280_ (.A(\box_y[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_266_));
 sky130_fd_sc_hd__inv_2 _281_ (.A(\hvsync_gen.hpos[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_267_));
 sky130_fd_sc_hd__inv_2 _282_ (.A(\hvsync_gen.hpos[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_268_));
 sky130_fd_sc_hd__inv_2 _283_ (.A(net50),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_269_));
 sky130_fd_sc_hd__inv_2 _284_ (.A(\hvsync_gen.hpos[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_270_));
 sky130_fd_sc_hd__inv_2 _285_ (.A(\hvsync_gen.hpos[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_271_));
 sky130_fd_sc_hd__inv_2 _286_ (.A(\hvsync_gen.hpos[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_272_));
 sky130_fd_sc_hd__inv_2 _287_ (.A(\hvsync_gen.vpos[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_273_));
 sky130_fd_sc_hd__inv_2 _288_ (.A(\hvsync_gen.vpos[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_274_));
 sky130_fd_sc_hd__inv_2 _289_ (.A(\hvsync_gen.vpos[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_275_));
 sky130_fd_sc_hd__inv_2 _290_ (.A(\hvsync_gen.vpos[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_042_));
 sky130_fd_sc_hd__inv_2 _291_ (.A(\hvsync_gen.vpos[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_043_));
 sky130_fd_sc_hd__inv_2 _292_ (.A(\hvsync_gen.vpos[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_044_));
 sky130_fd_sc_hd__inv_2 _293_ (.A(net47),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_045_));
 sky130_fd_sc_hd__or4b_2 _294_ (.A(_273_),
    .B(_274_),
    .C(_275_),
    .D_N(\hvsync_gen.vpos[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_046_));
 sky130_fd_sc_hd__nand2_2 _295_ (.A(\hvsync_gen.hpos[8] ),
    .B(\hvsync_gen.hpos[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_047_));
 sky130_fd_sc_hd__nand2_2 _296_ (.A(\hvsync_gen.hpos[7] ),
    .B(\hvsync_gen.hpos[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_048_));
 sky130_fd_sc_hd__nand3_2 _297_ (.A(_046_),
    .B(_047_),
    .C(_048_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_049_));
 sky130_fd_sc_hd__nor2_2 _298_ (.A(\hvsync_gen.vpos[9] ),
    .B(_049_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o211a_2 _299_ (.A1(\box_y[2] ),
    .A2(_043_),
    .B1(_044_),
    .C1(\box_y[1] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_050_));
 sky130_fd_sc_hd__a22o_2 _300_ (.A1(\box_y[3] ),
    .A2(_042_),
    .B1(_043_),
    .B2(\box_y[2] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_051_));
 sky130_fd_sc_hd__nand2_2 _301_ (.A(_266_),
    .B(\hvsync_gen.vpos[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_052_));
 sky130_fd_sc_hd__o221ai_2 _302_ (.A1(\box_y[3] ),
    .A2(_042_),
    .B1(_050_),
    .B2(_051_),
    .C1(_052_),
    ...
    .VPWR(VPWR),
    .Y(_053_));
 sky130_fd_sc_hd__nor2_2 _303_ (.A(\box_y[5] ),
    .B(_275_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_054_));
 sky130_fd_sc_hd__a2bb2o_2 _304_ (.A1_N(\hvsync_gen.vpos[4] ),
    .A2_N(_266_),
    .B1(\box_y[5] ),
    .B2(_275_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_055_));
 sky130_fd_sc_hd__nor2_2 _305_ (.A(_054_),
    .B(_055_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_056_));
 sky130_fd_sc_hd__nand2_2 _306_ (.A(_053_),
    .B(_056_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_057_));
 sky130_fd_sc_hd__a221o_2 _307_ (.A1(net17),
    ...
    .VPWR(VPWR),
    .X(_058_));
 sky130_fd_sc_hd__nand2_2 _308_ (.A(net16),
    .B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_059_));
 sky130_fd_sc_hd__or2_2 _309_ (.A(net16),
    .B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_060_));
 sky130_fd_sc_hd__nand2_2 _310_ (.A(_059_),
    .B(_060_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_061_));
 sky130_fd_sc_hd__o221a_2 _311_ (.A1(net17),
    .A2(\hvsync_gen.vpos[6] ),
    .B1(_061_),
    ...
    .VPWR(VPWR),
    .X(_062_));
 sky130_fd_sc_hd__and3_2 _312_ (.A(net15),
    .B(net16),
    .C(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_063_));
 sky130_fd_sc_hd__a21oi_2 _313_ (.A1(net16),
    .A2(\box_y[6] ),
    .B1(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_064_));
 sky130_fd_sc_hd__or2_2 _314_ (.A(_063_),
    .B(_064_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_065_));
 sky130_fd_sc_hd__a221o_2 _315_ (.A1(\hvsync_gen.vpos[7] ),
    .A2(_061_),
    .B1(_065_),
    ...
    .VPWR(VPWR),
    .X(_066_));
 sky130_fd_sc_hd__xnor2_2 _316_ (.A(\box_y[9] ),
    .B(_063_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_067_));
 sky130_fd_sc_hd__or2_2 _317_ (.A(\hvsync_gen.vpos[9] ),
    .B(_067_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_068_));
 sky130_fd_sc_hd__nand2_2 _318_ (.A(\hvsync_gen.vpos[9] ),
    .B(_067_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_069_));
 sky130_fd_sc_hd__o211a_2 _319_ (.A1(\hvsync_gen.vpos[8] ),
    .A2(_065_),
    .B1(_068_),
    .C1(_069_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_070_));
 sky130_fd_sc_hd__o211a_2 _320_ (.A1(\box_x[2] ),
    .A2(_268_),
    .B1(_267_),
    .C1(\box_x[1] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_071_));
 sky130_fd_sc_hd__a22o_2 _321_ (.A1(\box_x[2] ),
    .A2(_268_),
    .B1(_269_),
    .B2(\box_x[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_072_));
 sky130_fd_sc_hd__o22a_2 _322_ (.A1(\box_x[3] ),
    .A2(_269_),
    .B1(_270_),
    .B2(\box_x[4] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_073_));
 sky130_fd_sc_hd__o21ai_2 _323_ (.A1(_071_),
    .A2(_072_),
    .B1(_073_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_074_));
 sky130_fd_sc_hd__and2b_2 _324_ (.A_N(net14),
    .B(\hvsync_gen.hpos[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_075_));
 sky130_fd_sc_hd__a22oi_2 _325_ (.A1(\box_x[4] ),
    .A2(_270_),
    .B1(_271_),
    .B2(net14),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_076_));
 sky130_fd_sc_hd__o211ai_2 _326_ (.A1(net14),
    .A2(_271_),
    .B1(_074_),
    .C1(_076_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_077_));
 sky130_fd_sc_hd__and2_2 _327_ (.A(net13),
    .B(\hvsync_gen.hpos[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_078_));
 sky130_fd_sc_hd__a211o_2 _328_ (.A1(_074_),
    .A2(_076_),
    .B1(_078_),
    .C1(_075_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_079_));
 sky130_fd_sc_hd__nor2_2 _329_ (.A(net13),
    .B(\hvsync_gen.hpos[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_080_));
 sky130_fd_sc_hd__and2_2 _330_ (.A(net12),
    .B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_081_));
 sky130_fd_sc_hd__nor2_2 _331_ (.A(net12),
    .B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_082_));
 sky130_fd_sc_hd__o32a_2 _332_ (.A1(\hvsync_gen.hpos[7] ),
    .A2(_081_),
    .A3(_082_),
    ...
    .VPWR(VPWR),
    .X(_083_));
 sky130_fd_sc_hd__o21a_2 _333_ (.A1(_081_),
    .A2(_082_),
    ...
    .VPWR(VPWR),
    .X(_084_));
 sky130_fd_sc_hd__and3_2 _334_ (.A(\box_x[8] ),
    .B(net12),
    .C(net13),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_085_));
 sky130_fd_sc_hd__nor2_2 _335_ (.A(\box_x[8] ),
    .B(_081_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_086_));
 sky130_fd_sc_hd__or2_2 _336_ (.A(_085_),
    .B(_086_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_087_));
 sky130_fd_sc_hd__a221o_2 _337_ (.A1(_079_),
    .A2(_083_),
    .B1(_087_),
    ...
    .VPWR(VPWR),
    .X(_088_));
 sky130_fd_sc_hd__xnor2_2 _338_ (.A(\box_x[9] ),
    .B(_085_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_089_));
 sky130_fd_sc_hd__o221a_2 _339_ (.A1(\hvsync_gen.hpos[8] ),
    .A2(_087_),
    .B1(_089_),
    ...
    .VPWR(VPWR),
    .X(_090_));
 sky130_fd_sc_hd__a21oi_2 _340_ (.A1(_265_),
    .A2(\hvsync_gen.vpos[6] ),
    .B1(_054_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_091_));
 sky130_fd_sc_hd__nor2_2 _341_ (.A(_265_),
    .B(\hvsync_gen.vpos[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_092_));
 sky130_fd_sc_hd__a221o_2 _342_ (.A1(net16),
    .A2(_273_),
    .B1(_057_),
    .B2(_091_),
    .C1(_092_),
    ...
    .VPWR(VPWR),
    .X(_093_));
 sky130_fd_sc_hd__o22a_2 _343_ (.A1(net16),
    .A2(_273_),
    .B1(_274_),
    .B2(net15),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_094_));
 sky130_fd_sc_hd__and2b_2 _344_ (.A_N(\box_x[8] ),
    .B(\hvsync_gen.hpos[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_095_));
 sky130_fd_sc_hd__and2b_2 _345_ (.A_N(net12),
    .B(\hvsync_gen.hpos[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_096_));
 sky130_fd_sc_hd__nor2_2 _346_ (.A(_095_),
    .B(_096_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_097_));
 sky130_fd_sc_hd__and2b_2 _347_ (.A_N(\hvsync_gen.hpos[7] ),
    .B(\box_x[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_098_));
 sky130_fd_sc_hd__and2b_2 _348_ (.A_N(\hvsync_gen.hpos[8] ),
    .B(\box_x[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_099_));
 sky130_fd_sc_hd__or4_2 _349_ (.A(_095_),
    .B(_096_),
    .C(_098_),
    .D(_099_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_100_));
 sky130_fd_sc_hd__nor2_2 _350_ (.A(_078_),
    .B(_080_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_101_));
 sky130_fd_sc_hd__nand2_2 _351_ (.A(_263_),
    .B(\hvsync_gen.hpos[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_102_));
 sky130_fd_sc_hd__o21ai_2 _352_ (.A1(_078_),
    .A2(_080_),
    .B1(_075_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_103_));
 sky130_fd_sc_hd__a21o_2 _353_ (.A1(_102_),
    .A2(_103_),
    .B1(_100_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_104_));
 sky130_fd_sc_hd__o221a_2 _354_ (.A1(\box_x[9] ),
    .A2(_272_),
    .B1(_097_),
    .B2(_099_),
    .C1(_104_),
    ...
    .VPWR(VPWR),
    .X(_105_));
 sky130_fd_sc_hd__o31a_2 _355_ (.A1(_077_),
    .A2(_100_),
    .A3(_101_),
    .B1(_105_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_106_));
 sky130_fd_sc_hd__a221o_2 _356_ (.A1(\box_x[9] ),
    .A2(_272_),
    .B1(_274_),
    .B2(\box_y[8] ),
    .C1(\box_y[9] ),
    ...
    .VPWR(VPWR),
    .X(_107_));
 sky130_fd_sc_hd__a2111o_2 _357_ (.A1(\hvsync_gen.hpos[9] ),
    .A2(_089_),
    .B1(_107_),
    ...
    .VPWR(VPWR),
    .X(_108_));
 sky130_fd_sc_hd__a211o_2 _358_ (.A1(_093_),
    .A2(_094_),
    .B1(_106_),
    .C1(_108_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_109_));
 sky130_fd_sc_hd__a211oi_4 _359_ (.A1(_066_),
    .A2(_070_),
    .B1(_090_),
    .C1(_109_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(net2));
 sky130_fd_sc_hd__nand2_2 _360_ (.A(\hvsync_gen.vpos[1] ),
    .B(\hvsync_gen.vpos[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_110_));
 sky130_fd_sc_hd__or2_2 _361_ (.A(_043_),
    .B(_110_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_111_));
 sky130_fd_sc_hd__and4_2 _362_ (.A(\hvsync_gen.vpos[3] ),
    .B(\hvsync_gen.vpos[2] ),
    .C(\hvsync_gen.vpos[1] ),
    .D(\hvsync_gen.vpos[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_112_));
 sky130_fd_sc_hd__inv_2 _363_ (.A(_112_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_113_));
 sky130_fd_sc_hd__or2_2 _364_ (.A(\hvsync_gen.vpos[4] ),
    .B(_112_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_114_));
 sky130_fd_sc_hd__or3_2 _365_ (.A(\hvsync_gen.vpos[9] ),
    .B(_042_),
    .C(_044_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_115_));
 sky130_fd_sc_hd__a2111o_2 _366_ (.A1(net42),
    .A2(_045_),
    .B1(_046_),
    .C1(_114_),
    .D1(_115_),
    ...
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__and3_2 _367_ (.A(\hvsync_gen.hpos[4] ),
    .B(\hvsync_gen.hpos[5] ),
    .C(\hvsync_gen.hpos[6] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_116_));
 sky130_fd_sc_hd__or3_2 _368_ (.A(\hvsync_gen.hpos[4] ),
    .B(\hvsync_gen.hpos[5] ),
    .C(\hvsync_gen.hpos[6] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_117_));
 sky130_fd_sc_hd__or4b_2 _369_ (.A(net60),
    .B(_048_),
    .C(_116_),
    .D_N(_117_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_000_));
 sky130_fd_sc_hd__nand2_2 _370_ (.A(\box_y[2] ),
    .B(\box_y[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_118_));
 sky130_fd_sc_hd__and3_2 _371_ (.A(\box_y[3] ),
    .B(\box_y[2] ),
    .C(\box_y[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_119_));
 sky130_fd_sc_hd__a41o_2 _372_ (.A1(\box_y[4] ),
    .A2(\box_y[3] ),
    .A3(\box_y[2] ),
    .A4(\box_y[1] ),
    .B1(\box_y[5] ),
    ...
    .VPWR(VPWR),
    .X(_120_));
 sky130_fd_sc_hd__nand4_2 _373_ (.A(net15),
    .B(net16),
    .C(_265_),
    .D(_120_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_121_));
 sky130_fd_sc_hd__and3_2 _374_ (.A(\box_y[5] ),
    .B(\box_y[4] ),
    .C(_119_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_122_));
 sky130_fd_sc_hd__inv_2 _375_ (.A(_122_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_123_));
 sky130_fd_sc_hd__nor2_2 _376_ (.A(net8),
    .B(_122_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_124_));
 sky130_fd_sc_hd__and4_2 _377_ (.A(\box_y[9] ),
    .B(net15),
    .C(\box_y[7] ),
    .D(_265_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_125_));
 sky130_fd_sc_hd__a221oi_2 _378_ (.A1(_067_),
    .A2(_121_),
    .B1(_122_),
    .B2(_125_),
    .C1(net8),
    ...
    .VPWR(VPWR),
    .Y(_126_));
 sky130_fd_sc_hd__inv_2 _379_ (.A(_126_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_127_));
 sky130_fd_sc_hd__or3_2 _380_ (.A(net15),
    .B(\box_y[5] ),
    .C(_060_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_128_));
 sky130_fd_sc_hd__or4_2 _381_ (.A(\box_y[9] ),
    .B(\box_y[4] ),
    .C(\box_y[3] ),
    .D(\box_y[2] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_129_));
 sky130_fd_sc_hd__nor2_2 _382_ (.A(_128_),
    .B(_129_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_130_));
 sky130_fd_sc_hd__nand3_2 _383_ (.A(\hvsync_gen.hpos[0] ),
    .B(\hvsync_gen.hpos[1] ),
    .C(\hvsync_gen.hpos[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_131_));
 sky130_fd_sc_hd__nor2_2 _384_ (.A(_269_),
    .B(_131_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_132_));
 sky130_fd_sc_hd__nand4_2 _385_ (.A(\hvsync_gen.hpos[0] ),
    .B(\hvsync_gen.hpos[1] ),
    .C(\hvsync_gen.hpos[2] ),
    .D(\hvsync_gen.hpos[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_133_));
 sky130_fd_sc_hd__nor2_2 _386_ (.A(_270_),
    .B(_133_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_134_));
 sky130_fd_sc_hd__or4bb_2 _387_ (.A(\hvsync_gen.hpos[5] ),
    .B(\hvsync_gen.hpos[6] ),
    ...
    .VPWR(VPWR),
    .X(_135_));
 sky130_fd_sc_hd__or4_2 _388_ (.A(_270_),
    .B(\hvsync_gen.hpos[7] ),
    .C(_133_),
    .D(_135_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_136_));
 sky130_fd_sc_hd__or4b_2 _389_ (.A(\hvsync_gen.vpos[4] ),
    .B(_042_),
    .C(_043_),
    ...
    .VPWR(VPWR),
    .X(_137_));
 sky130_fd_sc_hd__or2_2 _390_ (.A(\hvsync_gen.vpos[1] ),
    .B(\hvsync_gen.vpos[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_138_));
 sky130_fd_sc_hd__or4_2 _391_ (.A(\hvsync_gen.vpos[7] ),
    .B(\hvsync_gen.vpos[8] ),
    .C(\hvsync_gen.vpos[5] ),
    .D(\hvsync_gen.vpos[6] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_139_));
 sky130_fd_sc_hd__or4_2 _392_ (.A(_136_),
    .B(_137_),
    .C(_138_),
    .D(_139_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_140_));
 sky130_fd_sc_hd__a211oi_2 _393_ (.A1(net8),
    .A2(_130_),
    .B1(_140_),
    .C1(_126_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_141_));
 sky130_fd_sc_hd__a211o_2 _394_ (.A1(net8),
    .A2(_130_),
    .B1(_140_),
    .C1(_126_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_142_));
 sky130_fd_sc_hd__or3_2 _395_ (.A(\hvsync_gen.hpos[6] ),
    .B(\hvsync_gen.hpos[7] ),
    .C(_047_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_143_));
 sky130_fd_sc_hd__or3b_2 _396_ (.A(_143_),
    .B(\hvsync_gen.hpos[5] ),
    .C_N(_134_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_144_));
 sky130_fd_sc_hd__inv_2 _397_ (.A(_144_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_145_));
 sky130_fd_sc_hd__or3b_2 _398_ (.A(\hvsync_gen.vpos[6] ),
    .B(\hvsync_gen.vpos[4] ),
    ...
    .VPWR(VPWR),
    .X(_146_));
 sky130_fd_sc_hd__or4_2 _399_ (.A(\hvsync_gen.vpos[7] ),
    .B(\hvsync_gen.vpos[8] ),
    .C(\hvsync_gen.vpos[5] ),
    .D(_042_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_147_));
 sky130_fd_sc_hd__or4_2 _400_ (.A(_043_),
    .B(_138_),
    .C(_146_),
    .D(_147_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_148_));
 sky130_fd_sc_hd__o21ai_2 _401_ (.A1(net44),
    .A2(net5),
    .B1(net19),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_149_));
 sky130_fd_sc_hd__a21oi_2 _402_ (.A1(net44),
    .A2(net5),
    .B1(_149_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_002_));
 sky130_fd_sc_hd__or2_2 _403_ (.A(\box_y[2] ),
    .B(\box_y[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_150_));
 sky130_fd_sc_hd__a21oi_2 _404_ (.A1(_118_),
    .A2(_150_),
    .B1(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_151_));
 sky130_fd_sc_hd__and3_2 _405_ (.A(net9),
    .B(_118_),
    .C(_150_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_152_));
 sky130_fd_sc_hd__o31ai_2 _406_ (.A1(_142_),
    .A2(_151_),
    .A3(_152_),
    .B1(net19),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_153_));
 sky130_fd_sc_hd__a21o_2 _407_ (.A1(net58),
    .A2(_142_),
    .B1(_153_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_003_));
 sky130_fd_sc_hd__or3_2 _408_ (.A(\box_y[3] ),
    .B(\box_y[2] ),
    .C(\box_y[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_154_));
 sky130_fd_sc_hd__nand2_2 _409_ (.A(\box_y[3] ),
    .B(_150_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_155_));
 sky130_fd_sc_hd__and3_2 _410_ (.A(_151_),
    .B(_154_),
    .C(_155_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_156_));
 sky130_fd_sc_hd__a21oi_2 _411_ (.A1(_154_),
    .A2(_155_),
    .B1(_151_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_157_));
 sky130_fd_sc_hd__or3_2 _412_ (.A(_142_),
    .B(_156_),
    .C(_157_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_158_));
 sky130_fd_sc_hd__o211a_2 _413_ (.A1(\box_y[3] ),
    .A2(net5),
    .B1(_158_),
    .C1(net19),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_004_));
 sky130_fd_sc_hd__nand2_2 _414_ (.A(net9),
    .B(_154_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_159_));
 sky130_fd_sc_hd__o211a_2 _415_ (.A1(net9),
    .A2(_119_),
    .B1(net5),
    .C1(_159_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_160_));
 sky130_fd_sc_hd__o21ai_2 _416_ (.A1(net43),
    .A2(_160_),
    .B1(net19),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_161_));
 sky130_fd_sc_hd__a21oi_2 _417_ (.A1(net43),
    .A2(_160_),
    .B1(_161_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_005_));
 sky130_fd_sc_hd__or2_2 _418_ (.A(\box_y[4] ),
    .B(_154_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_162_));
 sky130_fd_sc_hd__a21o_2 _419_ (.A1(net8),
    .A2(_162_),
    .B1(_142_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_163_));
 sky130_fd_sc_hd__or2_2 _420_ (.A(\box_y[5] ),
    .B(_162_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_164_));
 sky130_fd_sc_hd__o2bb2a_2 _421_ (.A1_N(_120_),
    .A2_N(_124_),
    .B1(_164_),
    .B2(_262_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_165_));
 sky130_fd_sc_hd__o21ai_2 _422_ (.A1(_142_),
    .A2(_165_),
    .B1(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_166_));
 sky130_fd_sc_hd__a21o_2 _423_ (.A1(net57),
    .A2(_163_),
    .B1(_166_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_006_));
 sky130_fd_sc_hd__a211o_2 _424_ (.A1(net8),
    .A2(_164_),
    .B1(_142_),
    .C1(_124_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_167_));
 sky130_fd_sc_hd__a21bo_2 _425_ (.A1(net17),
    .A2(_167_),
    .B1_N(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_168_));
 sky130_fd_sc_hd__o21bai_2 _426_ (.A1(net17),
    .A2(_167_),
    .B1_N(_168_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_007_));
 sky130_fd_sc_hd__or2_2 _427_ (.A(net17),
    .B(_164_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_169_));
 sky130_fd_sc_hd__a21oi_2 _428_ (.A1(net17),
    .A2(_122_),
    .B1(net8),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_170_));
 sky130_fd_sc_hd__a211oi_2 _429_ (.A1(net9),
    .A2(_169_),
    .B1(_170_),
    .C1(_142_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_171_));
 sky130_fd_sc_hd__o21ai_2 _430_ (.A1(net16),
    .A2(_171_),
    .B1(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_172_));
 sky130_fd_sc_hd__a21oi_2 _431_ (.A1(net16),
    .A2(_171_),
    .B1(_172_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_008_));
 sky130_fd_sc_hd__o21ai_2 _432_ (.A1(_128_),
    .A2(_162_),
    .B1(net8),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_173_));
 sky130_fd_sc_hd__o21a_2 _433_ (.A1(net16),
    .A2(_169_),
    .B1(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_174_));
 sky130_fd_sc_hd__nor3_2 _434_ (.A(net15),
    .B(_059_),
    .C(_123_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_175_));
 sky130_fd_sc_hd__o21a_2 _435_ (.A1(_059_),
    .A2(_123_),
    .B1(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_176_));
 sky130_fd_sc_hd__o32a_2 _436_ (.A1(net9),
    .A2(_175_),
    .A3(_176_),
    .B1(_173_),
    .B2(_174_),
    ...
    .VPWR(VPWR),
    .X(_177_));
 sky130_fd_sc_hd__or2_2 _437_ (.A(net15),
    .B(_141_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_178_));
 sky130_fd_sc_hd__o211a_2 _438_ (.A1(_142_),
    .A2(_177_),
    .B1(_178_),
    .C1(net18),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_009_));
 sky130_fd_sc_hd__a21o_2 _439_ (.A1(_063_),
    .A2(_122_),
    .B1(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_179_));
 sky130_fd_sc_hd__nand2_2 _440_ (.A(net49),
    .B(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_180_));
 sky130_fd_sc_hd__a31oi_2 _441_ (.A1(_141_),
    .A2(_173_),
    .A3(_179_),
    .B1(_180_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_010_));
 sky130_fd_sc_hd__and2_2 _442_ (.A(\box_x[2] ),
    .B(\box_x[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_181_));
 sky130_fd_sc_hd__and3_2 _443_ (.A(\box_x[3] ),
    .B(\box_x[2] ),
    .C(\box_x[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_182_));
 sky130_fd_sc_hd__and4_2 _444_ (.A(\box_x[4] ),
    .B(\box_x[3] ),
    .C(\box_x[2] ),
    .D(\box_x[1] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_183_));
 sky130_fd_sc_hd__nand2_2 _445_ (.A(net14),
    .B(_183_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_184_));
 sky130_fd_sc_hd__and4_2 _446_ (.A(\box_x[8] ),
    .B(net12),
    .C(net14),
    .D(_183_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_185_));
 sky130_fd_sc_hd__a2111oi_2 _447_ (.A1(net14),
    .A2(_183_),
    .B1(\box_x[8] ),
    .C1(net12),
    .D1(net13),
    ...
    .VPWR(VPWR),
    .Y(_186_));
 sky130_fd_sc_hd__or3b_2 _448_ (.A(net10),
    .B(_085_),
    .C_N(\box_x[9] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_187_));
 sky130_fd_sc_hd__a211o_2 _449_ (.A1(_263_),
    .A2(_185_),
    .B1(_186_),
    .C1(_187_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_188_));
 sky130_fd_sc_hd__or4_2 _450_ (.A(\box_x[8] ),
    .B(net12),
    .C(net13),
    .D(net14),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_189_));
 sky130_fd_sc_hd__or3_2 _451_ (.A(\box_x[4] ),
    .B(\box_x[3] ),
    .C(\box_x[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_190_));
 sky130_fd_sc_hd__or4b_2 _452_ (.A(\box_x[9] ),
    .B(_189_),
    .C(_190_),
    .D_N(net10),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_191_));
 sky130_fd_sc_hd__and3b_2 _453_ (.A_N(_140_),
    .B(_188_),
    .C(_191_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_192_));
 sky130_fd_sc_hd__o21ai_2 _454_ (.A1(\box_x[1] ),
    .A2(net3),
    .B1(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_193_));
 sky130_fd_sc_hd__a21oi_2 _455_ (.A1(net54),
    .A2(net3),
    .B1(_193_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_011_));
 sky130_fd_sc_hd__nor2_2 _456_ (.A(\box_x[2] ),
    .B(\box_x[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_194_));
 sky130_fd_sc_hd__o21a_2 _457_ (.A1(_181_),
    .A2(_194_),
    .B1(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_195_));
 sky130_fd_sc_hd__nor3_2 _458_ (.A(net10),
    .B(_181_),
    .C(_194_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_196_));
 sky130_fd_sc_hd__or2_2 _459_ (.A(_195_),
    .B(_196_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_197_));
 sky130_fd_sc_hd__o21ai_2 _460_ (.A1(_264_),
    .A2(net3),
    .B1(net21),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_198_));
 sky130_fd_sc_hd__a21o_2 _461_ (.A1(net3),
    .A2(_197_),
    .B1(_198_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_012_));
 sky130_fd_sc_hd__nor2_2 _462_ (.A(\box_x[3] ),
    .B(_181_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_199_));
 sky130_fd_sc_hd__nor2_2 _463_ (.A(_182_),
    .B(_199_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_200_));
 sky130_fd_sc_hd__xnor2_2 _464_ (.A(_195_),
    .B(_200_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_201_));
 sky130_fd_sc_hd__nand2_2 _465_ (.A(net4),
    .B(_201_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_202_));
 sky130_fd_sc_hd__o211a_2 _466_ (.A1(\box_x[3] ),
    .A2(net4),
    .B1(_202_),
    .C1(net22),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_013_));
 sky130_fd_sc_hd__o31a_2 _467_ (.A1(\box_x[3] ),
    .A2(\box_x[2] ),
    .A3(\box_x[1] ),
    .B1(net10),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_203_));
 sky130_fd_sc_hd__o21ba_2 _468_ (.A1(net11),
    .A2(_182_),
    .B1_N(_203_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_204_));
 sky130_fd_sc_hd__nand3_2 _469_ (.A(\box_x[4] ),
    .B(net4),
    .C(_204_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_205_));
 sky130_fd_sc_hd__a21o_2 _470_ (.A1(net4),
    .A2(_204_),
    .B1(\box_x[4] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_206_));
 sky130_fd_sc_hd__and3_2 _471_ (.A(net22),
    .B(_205_),
    .C(_206_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_014_));
 sky130_fd_sc_hd__or2_2 _472_ (.A(\box_x[1] ),
    .B(_190_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_207_));
 sky130_fd_sc_hd__nand2_2 _473_ (.A(net11),
    .B(_207_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_208_));
 sky130_fd_sc_hd__o211ai_2 _474_ (.A1(net11),
    .A2(_183_),
    .B1(net4),
    .C1(_208_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_209_));
 sky130_fd_sc_hd__o21ai_2 _475_ (.A1(\box_x[5] ),
    .A2(_209_),
    .B1(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_210_));
 sky130_fd_sc_hd__a21o_2 _476_ (.A1(net46),
    .A2(_209_),
    .B1(_210_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_015_));
 sky130_fd_sc_hd__or3b_2 _477_ (.A(\box_x[5] ),
    .B(_207_),
    .C_N(net11),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_211_));
 sky130_fd_sc_hd__o21ai_2 _478_ (.A1(net11),
    .A2(_184_),
    .B1(_211_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_212_));
 sky130_fd_sc_hd__nand2_2 _479_ (.A(net4),
    .B(_212_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_213_));
 sky130_fd_sc_hd__o21ai_2 _480_ (.A1(\box_x[6] ),
    .A2(_213_),
    .B1(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_214_));
 sky130_fd_sc_hd__a21o_2 _481_ (.A1(net48),
    .A2(_213_),
    .B1(_214_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_016_));
 sky130_fd_sc_hd__o32a_2 _482_ (.A1(\box_x[6] ),
    .A2(\box_x[5] ),
    .A3(_207_),
    .B1(_184_),
    .B2(net11),
    ...
    .VPWR(VPWR),
    .X(_215_));
 sky130_fd_sc_hd__o21ba_2 _483_ (.A1(net10),
    .A2(\box_x[6] ),
    .B1_N(_215_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_216_));
 sky130_fd_sc_hd__nand3_2 _484_ (.A(net12),
    .B(net3),
    .C(_216_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_217_));
 sky130_fd_sc_hd__a21o_2 _485_ (.A1(net3),
    .A2(_216_),
    .B1(net12),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_218_));
 sky130_fd_sc_hd__and3_2 _486_ (.A(net22),
    .B(_217_),
    .C(_218_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_017_));
 sky130_fd_sc_hd__and3_2 _487_ (.A(net14),
    .B(_085_),
    .C(_183_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_219_));
 sky130_fd_sc_hd__a31oi_2 _488_ (.A1(net14),
    .A2(_081_),
    .A3(_183_),
    .B1(\box_x[8] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_220_));
 sky130_fd_sc_hd__o21ba_2 _489_ (.A1(_219_),
    .A2(_220_),
    .B1_N(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_221_));
 sky130_fd_sc_hd__o21ai_2 _490_ (.A1(_189_),
    .A2(_207_),
    .B1(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_222_));
 sky130_fd_sc_hd__o41a_2 _491_ (.A1(net12),
    .A2(net13),
    .A3(net14),
    .A4(_207_),
    .B1(\box_x[8] ),
    ...
    .VPWR(VPWR),
    .X(_223_));
 sky130_fd_sc_hd__nor2_2 _492_ (.A(_222_),
    .B(_223_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_224_));
 sky130_fd_sc_hd__o21ai_2 _493_ (.A1(_221_),
    .A2(_224_),
    .B1(net3),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_225_));
 sky130_fd_sc_hd__o211a_2 _494_ (.A1(\box_x[8] ),
    .A2(net3),
    .B1(_225_),
    .C1(net22),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_018_));
 sky130_fd_sc_hd__or2_2 _495_ (.A(net10),
    .B(_219_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_226_));
 sky130_fd_sc_hd__nand4_2 _496_ (.A(\box_x[9] ),
    .B(net3),
    .C(_222_),
    .D(_226_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_227_));
 sky130_fd_sc_hd__a31o_2 _497_ (.A1(net3),
    .A2(_222_),
    .A3(_226_),
    .B1(\box_x[9] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_228_));
 sky130_fd_sc_hd__and3_2 _498_ (.A(net20),
    .B(_227_),
    .C(_228_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_019_));
 sky130_fd_sc_hd__and3_2 _499_ (.A(net20),
    .B(_145_),
    .C(_148_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_229_));
 sky130_fd_sc_hd__and2_2 _500_ (.A(net20),
    .B(_136_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_230_));
 sky130_fd_sc_hd__mux2_1 _501_ (.A0(_229_),
    .A1(net6),
    .S(net47),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_020_));
 sky130_fd_sc_hd__a32o_2 _502_ (.A1(_110_),
    .A2(_138_),
    .A3(_229_),
    .B1(net6),
    .B2(net45),
    ...
    .VPWR(VPWR),
    .X(_021_));
 sky130_fd_sc_hd__nand2_2 _503_ (.A(_043_),
    .B(_110_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_231_));
 sky130_fd_sc_hd__a32o_2 _504_ (.A1(_111_),
    .A2(_229_),
    .A3(_231_),
    .B1(net6),
    .B2(net42),
    ...
    .VPWR(VPWR),
    .X(_022_));
 sky130_fd_sc_hd__nand2_2 _505_ (.A(_042_),
    .B(_111_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_232_));
 sky130_fd_sc_hd__a32o_2 _506_ (.A1(_113_),
    .A2(_229_),
    .A3(_232_),
    .B1(net6),
    .B2(net38),
    ...
    .VPWR(VPWR),
    .X(_023_));
 sky130_fd_sc_hd__nand2_2 _507_ (.A(\hvsync_gen.vpos[4] ),
    .B(_112_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_233_));
 sky130_fd_sc_hd__a32o_2 _508_ (.A1(_114_),
    .A2(_229_),
    .A3(_233_),
    .B1(net6),
    .B2(net56),
    ...
    .VPWR(VPWR),
    .X(_024_));
 sky130_fd_sc_hd__nand2_2 _509_ (.A(_275_),
    .B(_233_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_234_));
 sky130_fd_sc_hd__nor2_2 _510_ (.A(_275_),
    .B(_233_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_235_));
 sky130_fd_sc_hd__inv_2 _511_ (.A(_235_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_236_));
 sky130_fd_sc_hd__a32o_2 _512_ (.A1(_229_),
    .A2(_234_),
    .A3(_236_),
    .B1(net6),
    .B2(net39),
    ...
    .VPWR(VPWR),
    .X(_025_));
 sky130_fd_sc_hd__nand2_2 _513_ (.A(\hvsync_gen.vpos[6] ),
    .B(_235_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_237_));
 sky130_fd_sc_hd__or2_2 _514_ (.A(\hvsync_gen.vpos[6] ),
    .B(_235_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_238_));
 sky130_fd_sc_hd__a32o_2 _515_ (.A1(_229_),
    .A2(_237_),
    .A3(_238_),
    .B1(net6),
    ...
    .VPWR(VPWR),
    .X(_026_));
 sky130_fd_sc_hd__nor2_2 _516_ (.A(_273_),
    .B(_237_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_239_));
 sky130_fd_sc_hd__inv_2 _517_ (.A(_239_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_240_));
 sky130_fd_sc_hd__nand2_2 _518_ (.A(_273_),
    .B(_237_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_241_));
 sky130_fd_sc_hd__a32o_2 _519_ (.A1(_229_),
    .A2(_240_),
    .A3(_241_),
    .B1(net6),
    .B2(net52),
    ...
    .VPWR(VPWR),
    .X(_027_));
 sky130_fd_sc_hd__or2_2 _520_ (.A(_046_),
    .B(_233_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_242_));
 sky130_fd_sc_hd__a31o_2 _521_ (.A1(net20),
    .A2(_148_),
    .A3(_242_),
    .B1(net6),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_243_));
 sky130_fd_sc_hd__a21o_2 _522_ (.A1(_229_),
    .A2(_239_),
    ...
    .VPWR(VPWR),
    .X(_244_));
 sky130_fd_sc_hd__and2_2 _523_ (.A(_243_),
    .B(_244_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_028_));
 sky130_fd_sc_hd__and3_2 _524_ (.A(\hvsync_gen.vpos[8] ),
    .B(_229_),
    .C(_239_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_245_));
 sky130_fd_sc_hd__mux2_1 _525_ (.A0(_245_),
    .A1(_243_),
    .S(\hvsync_gen.vpos[9] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_029_));
 sky130_fd_sc_hd__and2b_2 _526_ (.A_N(\hvsync_gen.hpos[0] ),
    .B(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_030_));
 sky130_fd_sc_hd__o21ai_2 _527_ (.A1(net40),
    ...
    .VPWR(VPWR),
    .Y(_246_));
 sky130_fd_sc_hd__a21oi_2 _528_ (.A1(net40),
    .A2(\hvsync_gen.hpos[1] ),
    .B1(_246_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_031_));
 sky130_fd_sc_hd__a21o_2 _529_ (.A1(\hvsync_gen.hpos[0] ),
    .A2(\hvsync_gen.hpos[1] ),
    ...
    .VPWR(VPWR),
    .X(_247_));
 sky130_fd_sc_hd__and3_2 _530_ (.A(_131_),
    .B(net7),
    .C(_247_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_032_));
 sky130_fd_sc_hd__nand2_2 _531_ (.A(net1),
    .B(_133_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_248_));
 sky130_fd_sc_hd__a21oi_2 _532_ (.A1(_269_),
    .A2(_131_),
    .B1(_248_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_033_));
 sky130_fd_sc_hd__o21ai_2 _533_ (.A1(net53),
    .A2(_132_),
    .B1(net1),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_249_));
 sky130_fd_sc_hd__nor2_2 _534_ (.A(_134_),
    .B(_249_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_034_));
 sky130_fd_sc_hd__and2_2 _535_ (.A(\hvsync_gen.hpos[5] ),
    .B(_134_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_250_));
 sky130_fd_sc_hd__o21ai_2 _536_ (.A1(net59),
    .A2(_134_),
    .B1(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_251_));
 sky130_fd_sc_hd__nor2_2 _537_ (.A(_250_),
    .B(_251_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_035_));
 sky130_fd_sc_hd__or2_2 _538_ (.A(\hvsync_gen.hpos[6] ),
    .B(_250_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_252_));
 sky130_fd_sc_hd__nand2_2 _539_ (.A(_116_),
    .B(_132_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_253_));
 sky130_fd_sc_hd__and3_2 _540_ (.A(net7),
    .B(_252_),
    .C(_253_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_036_));
 sky130_fd_sc_hd__xnor2_2 _541_ (.A(\hvsync_gen.hpos[7] ),
    .B(_253_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_254_));
 sky130_fd_sc_hd__and2_2 _542_ (.A(net7),
    .B(_254_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_037_));
 sky130_fd_sc_hd__a31o_2 _543_ (.A1(\hvsync_gen.hpos[7] ),
    .A2(_116_),
    .A3(_132_),
    ...
    .VPWR(VPWR),
    .X(_255_));
 sky130_fd_sc_hd__and4_2 _544_ (.A(\hvsync_gen.hpos[7] ),
    .B(\hvsync_gen.hpos[8] ),
    .C(_116_),
    .D(_132_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_256_));
 sky130_fd_sc_hd__and3b_2 _545_ (.A_N(_256_),
    .B(net7),
    .C(_255_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_038_));
 sky130_fd_sc_hd__o21ai_2 _546_ (.A1(\hvsync_gen.hpos[9] ),
    .A2(_256_),
    .B1(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_257_));
 sky130_fd_sc_hd__a21oi_2 _547_ (.A1(net55),
    .A2(_256_),
    .B1(_257_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_039_));
 sky130_fd_sc_hd__o41a_2 _548_ (.A1(\box_x[9] ),
    .A2(_140_),
    .A3(_189_),
    .A4(_190_),
    .B1(net10),
    ...
    .VPWR(VPWR),
    .X(_258_));
 sky130_fd_sc_hd__nor2_2 _549_ (.A(_140_),
    .B(_188_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_259_));
 sky130_fd_sc_hd__o21a_2 _550_ (.A1(_258_),
    .A2(_259_),
    .B1(net20),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_040_));
 sky130_fd_sc_hd__o31a_2 _551_ (.A1(_128_),
    .A2(_129_),
    .A3(_140_),
    .B1(net8),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_260_));
 sky130_fd_sc_hd__nor2_2 _552_ (.A(_127_),
    .B(_140_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_261_));
 sky130_fd_sc_hd__o21a_2 _553_ (.A1(_260_),
    .A2(_261_),
    .B1(net19),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_041_));
 sky130_fd_sc_hd__dfxtp_2 _554_ (.CLK(clknet_3_0__leaf_clk),
    .D(_002_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\box_y[1] ));
 sky130_fd_sc_hd__dfxtp_2 _555_ (.CLK(clknet_3_0__leaf_clk),
    .D(_003_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\box_y[2] ));
 sky130_fd_sc_hd__dfxtp_2 _556_ (.CLK(clknet_3_0__leaf_clk),
    .D(_004_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\box_y[3] ));
 sky130_fd_sc_hd__dfxtp_2 _557_ (.CLK(clknet_3_0__leaf_clk),
    .D(_005_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\box_y[4] ));
 sky130_fd_sc_hd__dfxtp_2 _558_ (.CLK(clknet_3_0__leaf_clk),
    .D(_006_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\box_y[5] ));
 sky130_fd_sc_hd__dfxtp_2 _559_ (.CLK(clknet_3_0__leaf_clk),
    .D(_007_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\box_y[6] ));
 sky130_fd_sc_hd__dfxtp_2 _560_ (.CLK(clknet_3_1__leaf_clk),
    .D(_008_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\box_y[7] ));
 sky130_fd_sc_hd__dfxtp_2 _561_ (.CLK(clknet_3_1__leaf_clk),
    .D(_009_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\box_y[8] ));
 sky130_fd_sc_hd__dfxtp_2 _562_ (.CLK(clknet_3_1__leaf_clk),
    .D(_010_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\box_y[9] ));
 sky130_fd_sc_hd__dfxtp_2 _563_ (.CLK(clknet_3_5__leaf_clk),
    .D(_011_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\box_x[1] ));
 sky130_fd_sc_hd__dfxtp_2 _564_ (.CLK(clknet_3_5__leaf_clk),
    .D(_012_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\box_x[2] ));
 sky130_fd_sc_hd__dfxtp_2 _565_ (.CLK(clknet_3_5__leaf_clk),
    .D(_013_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\box_x[3] ));
 sky130_fd_sc_hd__dfxtp_2 _566_ (.CLK(clknet_3_4__leaf_clk),
    .D(_014_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\box_x[4] ));
 sky130_fd_sc_hd__dfxtp_2 _567_ (.CLK(clknet_3_5__leaf_clk),
    .D(_015_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\box_x[5] ));
 sky130_fd_sc_hd__dfxtp_2 _568_ (.CLK(clknet_3_5__leaf_clk),
    .D(_016_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\box_x[6] ));
 sky130_fd_sc_hd__dfxtp_2 _569_ (.CLK(clknet_3_4__leaf_clk),
    .D(_017_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\box_x[7] ));
 sky130_fd_sc_hd__dfxtp_2 _570_ (.CLK(clknet_3_4__leaf_clk),
    .D(_018_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\box_x[8] ));
 sky130_fd_sc_hd__dfxtp_2 _571_ (.CLK(clknet_3_4__leaf_clk),
    .D(_019_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\box_x[9] ));
 sky130_fd_sc_hd__dfxtp_2 _572_ (.CLK(clknet_3_2__leaf_clk),
    .D(_020_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.vpos[0] ));
 sky130_fd_sc_hd__dfxtp_2 _573_ (.CLK(clknet_3_2__leaf_clk),
    .D(_021_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.vpos[1] ));
 sky130_fd_sc_hd__dfxtp_2 _574_ (.CLK(clknet_3_2__leaf_clk),
    .D(_022_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.vpos[2] ));
 sky130_fd_sc_hd__dfxtp_2 _575_ (.CLK(clknet_3_2__leaf_clk),
    .D(_023_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.vpos[3] ));
 sky130_fd_sc_hd__dfxtp_2 _576_ (.CLK(clknet_3_3__leaf_clk),
    .D(_024_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.vpos[4] ));
 sky130_fd_sc_hd__dfxtp_2 _577_ (.CLK(clknet_3_3__leaf_clk),
    .D(_025_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.vpos[5] ));
 sky130_fd_sc_hd__dfxtp_2 _578_ (.CLK(clknet_3_3__leaf_clk),
    .D(_026_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.vpos[6] ));
 sky130_fd_sc_hd__dfxtp_2 _579_ (.CLK(clknet_3_1__leaf_clk),
    .D(_027_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.vpos[7] ));
 sky130_fd_sc_hd__dfxtp_2 _580_ (.CLK(clknet_3_3__leaf_clk),
    .D(_028_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.vpos[8] ));
 sky130_fd_sc_hd__dfxtp_2 _581_ (.CLK(clknet_3_3__leaf_clk),
    .D(_029_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.vpos[9] ));
 sky130_fd_sc_hd__dfxtp_2 _582_ (.CLK(clknet_3_7__leaf_clk),
    .D(_030_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.hpos[0] ));
 sky130_fd_sc_hd__dfxtp_2 _583_ (.CLK(clknet_3_7__leaf_clk),
    .D(net41),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.hpos[1] ));
 sky130_fd_sc_hd__dfxtp_2 _584_ (.CLK(clknet_3_7__leaf_clk),
    .D(_032_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.hpos[2] ));
 sky130_fd_sc_hd__dfxtp_2 _585_ (.CLK(clknet_3_7__leaf_clk),
    .D(net51),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.hpos[3] ));
 sky130_fd_sc_hd__dfxtp_2 _586_ (.CLK(clknet_3_4__leaf_clk),
    .D(_034_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.hpos[4] ));
 sky130_fd_sc_hd__dfxtp_2 _587_ (.CLK(clknet_3_7__leaf_clk),
    .D(_035_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.hpos[5] ));
 sky130_fd_sc_hd__dfxtp_2 _588_ (.CLK(clknet_3_6__leaf_clk),
    .D(_036_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.hpos[6] ));
 sky130_fd_sc_hd__dfxtp_2 _589_ (.CLK(clknet_3_6__leaf_clk),
    .D(_037_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.hpos[7] ));
 sky130_fd_sc_hd__dfxtp_2 _590_ (.CLK(clknet_3_6__leaf_clk),
    .D(_038_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.hpos[8] ));
 sky130_fd_sc_hd__dfxtp_2 _591_ (.CLK(clknet_3_6__leaf_clk),
    .D(_039_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.hpos[9] ));
 sky130_fd_sc_hd__dfxtp_2 _592_ (.CLK(clknet_3_4__leaf_clk),
    .D(_040_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _593_ (.CLK(clknet_3_1__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(dir_y));
 sky130_fd_sc_hd__dfxtp_2 _594_ (.CLK(clknet_3_6__leaf_clk),
    .D(_000_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(hsync));
 sky130_fd_sc_hd__dfxtp_2 _595_ (.CLK(clknet_3_2__leaf_clk),
    .D(_001_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.vsync ));
 sky130_fd_sc_hd__buf_2 _612_ (.A(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[0]));
 sky130_fd_sc_hd__buf_2 _613_ (.A(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[1]));
 sky130_fd_sc_hd__buf_2 _614_ (.A(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[2]));
 sky130_fd_sc_hd__buf_2 _615_ (.A(\hvsync_gen.vsync ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[3]));
 sky130_fd_sc_hd__buf_2 _616_ (.A(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[4]));
 sky130_fd_sc_hd__buf_2 _617_ (.A(\hvsync_gen.display_on ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[6]));
 sky130_fd_sc_hd__buf_2 _618_ (.A(hsync),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 clkload5 (.A(clknet_3_7__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout10 (.A(dir_x),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net10));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout11 (.A(dir_x),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net11));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout12 (.A(\box_x[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net12));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout13 (.A(\box_x[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net13));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout14 (.A(\box_x[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net14));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout15 (.A(\box_y[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net15));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout16 (.A(\box_y[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net16));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout17 (.A(\box_y[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net17));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout18 (.A(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout21 (.A(net1),
    ...
    .VPWR(VPWR),
    .X(net21));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout3 (.A(_192_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net3));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout4 (.A(_192_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net4));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout6 (.A(_230_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net6));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout7 (.A(_230_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout8 (.A(net9),
    ...
    .VPWR(VPWR),
    .X(net8));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout9 (.A(dir_y),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__dlygate4sd3_1 hold38 (.A(\hvsync_gen.vpos[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold40 (.A(\hvsync_gen.hpos[0] ),
    ...
    .VPWR(VPWR),
    .X(net40));
 sky130_fd_sc_hd__dlygate4sd3_1 hold41 (.A(_031_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net41));
 sky130_fd_sc_hd__dlygate4sd3_1 hold42 (.A(\hvsync_gen.vpos[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net42));
 sky130_fd_sc_hd__dlygate4sd3_1 hold43 (.A(\box_y[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net43));
 sky130_fd_sc_hd__dlygate4sd3_1 hold44 (.A(\box_y[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net44));
 sky130_fd_sc_hd__dlygate4sd3_1 hold45 (.A(\hvsync_gen.vpos[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net45));
 sky130_fd_sc_hd__dlygate4sd3_1 hold46 (.A(\box_x[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net46));
 sky130_fd_sc_hd__dlygate4sd3_1 hold47 (.A(\hvsync_gen.vpos[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net47));
 sky130_fd_sc_hd__dlygate4sd3_1 hold48 (.A(\box_x[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net48));
 sky130_fd_sc_hd__dlygate4sd3_1 hold49 (.A(\box_y[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net49));
 sky130_fd_sc_hd__dlygate4sd3_1 hold50 (.A(\hvsync_gen.hpos[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net50));
 sky130_fd_sc_hd__dlygate4sd3_1 hold51 (.A(_033_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net51));
 sky130_fd_sc_hd__dlygate4sd3_1 hold52 (.A(\hvsync_gen.vpos[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net52));
 sky130_fd_sc_hd__dlygate4sd3_1 hold53 (.A(\hvsync_gen.hpos[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net53));
 sky130_fd_sc_hd__dlygate4sd3_1 hold54 (.A(\box_x[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net54));
 sky130_fd_sc_hd__dlygate4sd3_1 hold55 (.A(\hvsync_gen.hpos[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net55));
 sky130_fd_sc_hd__dlygate4sd3_1 hold56 (.A(\hvsync_gen.vpos[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net56));
 sky130_fd_sc_hd__dlygate4sd3_1 hold57 (.A(\box_y[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net57));
 sky130_fd_sc_hd__dlygate4sd3_1 hold58 (.A(\box_y[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net58));
 sky130_fd_sc_hd__dlygate4sd3_1 hold59 (.A(\hvsync_gen.hpos[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net59));
 sky130_fd_sc_hd__dlygate4sd3_1 hold60 (.A(\hvsync_gen.hpos[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 input1 (.A(rst_n),
    ...
    .VPWR(VPWR),
    .X(net1));
 sky130_fd_sc_hd__clkbuf_2 load_slew19 (.A(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net19));
 sky130_fd_sc_hd__buf_4 load_slew22 (.A(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net22));
 sky130_fd_sc_hd__conb_1 tt_um_sanity_bouncing_box (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_sanity_bouncing_box_23 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net23));
 sky130_fd_sc_hd__conb_1 tt_um_sanity_bouncing_box_24 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net24));
 sky130_fd_sc_hd__conb_1 tt_um_sanity_bouncing_box_25 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net25));
 sky130_fd_sc_hd__conb_1 tt_um_sanity_bouncing_box_26 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net26));
 sky130_fd_sc_hd__conb_1 tt_um_sanity_bouncing_box_27 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net27));
 sky130_fd_sc_hd__conb_1 tt_um_sanity_bouncing_box_28 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net28));
 sky130_fd_sc_hd__conb_1 tt_um_sanity_bouncing_box_29 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net29));
 sky130_fd_sc_hd__conb_1 tt_um_sanity_bouncing_box_30 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net30));
 sky130_fd_sc_hd__conb_1 tt_um_sanity_bouncing_box_31 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net31));
 sky130_fd_sc_hd__conb_1 tt_um_sanity_bouncing_box_32 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net32));
 sky130_fd_sc_hd__conb_1 tt_um_sanity_bouncing_box_33 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net33));
 sky130_fd_sc_hd__conb_1 tt_um_sanity_bouncing_box_34 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net34));
 sky130_fd_sc_hd__conb_1 tt_um_sanity_bouncing_box_35 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net35));
 sky130_fd_sc_hd__conb_1 tt_um_sanity_bouncing_box_36 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net36));
 sky130_fd_sc_hd__conb_1 tt_um_sanity_bouncing_box_37 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net37));
 sky130_fd_sc_hd__clkbuf_4 wire2 (.A(net2),
    ...
    .VPWR(VPWR),
    .X(uo_out[5]));
 sky130_fd_sc_hd__clkbuf_2 wire5 (.A(_141_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
